import {T as Le, f as Q, g as fe, h as he, j as U, F as j, k as b, V as pe, C as O, l as w, m as C, n as we, P as be, D as Se, o as B, e as P, I as Me, Q as me, p as Ie, O as ge, q as Ne, r as Ce, c as G, s as Oe, t as Te, N as ke, u as Pe, v as De, w as Z, x as Re, R as $, y as Fe, z as He, E as ve, H as V, L as Ue, J as xe, K as Ge, M as v, W as je, B as _e, X as Be, b as Ke, Y as Ve, d as ze, Z as Xe, _ as We, G as z, $ as qe, a0 as Ye, a1 as Je, a2 as Qe, a3 as Ze, a4 as $e, a5 as et, a6 as ye, a7 as tt, a8 as se, a9 as re, aa as ie, ab as oe, ac as ee, ad as nt, ae as st, af as rt, ag as it, S as ot} from "./GL.ndJIVeR0.js";
...
function ae(d, e) {
    ...
    if (e === Q || e === fe) {
        ...
        if (e === Q)
            ...
            for (let s = 0; s < i; s++)
                s % 2 === 0 ? (n.push(t.getX(s)),
                n.push(t.getX(s + 1)),
                n.push(t.getX(s + 2))) : (n.push(t.getX(s + 2)),
                n.push(t.getX(s + 1)),
                n.push(t.getX(s)));
...
class lt {
    constructor(e) {
        this.parser = e,
        this.name = R.KHR_MATERIALS_EMISSIVE_STRENGTH
    }
...
class dt {
    ...
    extendMaterialParams(e, t) {
        ...
        s.clearcoatRoughnessTexture !== void 0 && r.push(i.assignTexture(t, "clearcoatRoughnessMap", s.clearcoatRoughnessTexture)),
        s.clearcoatNormalTexture !== void 0 && (r.push(i.assignTexture(t, "clearcoatNormalMap", s.clearcoatNormalTexture)),
...
class ft {
    constructor(e) {
        this.parser = e,
        this.name = R.KHR_MATERIALS_DISPERSION
    }
    getMaterialType(e) {
        const i = this.parser.json.materials[e];
        return !i.extensions || !i.extensions[this.name] ? null : b
...
class ht {
    constructor(e) {
        this.parser = e,
        this.name = R.KHR_MATERIALS_IRIDESCENCE
    }
    getMaterialType(e) {
        const i = this.parser.json.materials[e];
        return !i.extensions || !i.extensions[this.name] ? null : b
    ...
    extendMaterialParams(e, t) {
        ...
        s.iridescenceThicknessTexture !== void 0 && r.push(i.assignTexture(t, "iridescenceThicknessMap", s.iridescenceThicknessTexture)),
        Promise.all(r)
    }
}
class pt {
    constructor(e) {
        this.parser = e,
        this.name = R.KHR_MATERIALS_SHEEN
    }
    getMaterialType(e) {
        const i = this.parser.json.materials[e];
        return !i.extensions || !i.extensions[this.name] ? null : b
    ...
    extendMaterialParams(e, t) {
        ...
        return s.sheenRoughnessFactor !== void 0 && (t.sheenRoughness = s.sheenRoughnessFactor),
...
class gt {
    constructor(e) {
        this.parser = e,
        this.name = R.KHR_MATERIALS_VOLUME
    }
    getMaterialType(e) {
        const i = this.parser.json.materials[e];
        return !i.extensions || !i.extensions[this.name] ? null : b
    ...
    extendMaterialParams(e, t) {
        ...
        return t.attenuationColor = new O().setRGB(a[0], a[1], a[2], w),
        Promise.all(r)
    }
}
class Tt {
...
class Rt {
    constructor(e) {
        this.parser = e,
        this.name = R.KHR_MATERIALS_SPECULAR
    }
    getMaterialType(e) {
        const i = this.parser.json.materials[e];
        return !i.extensions || !i.extensions[this.name] ? null : b
    ...
    extendMaterialParams(e, t) {
        ...
        return t.specularColor = new O().setRGB(a[0], a[1], a[2], w),
...
class xt {
    constructor(e) {
        this.parser = e,
        this.name = R.EXT_MATERIALS_BUMP
    }
    getMaterialType(e) {
        const i = this.parser.json.materials[e];
        return !i.extensions || !i.extensions[this.name] ? null : b
    ...
    extendMaterialParams(e, t) {
        ...
        const r = []
          , s = n.extensions[this.name];
        return t.bumpScale = s.bumpFactor !== void 0 ? s.bumpFactor : 1,
...
class _t {
    constructor(e) {
        this.parser = e,
        this.name = R.KHR_MATERIALS_ANISOTROPY
    }
    getMaterialType(e) {
        const i = this.parser.json.materials[e];
        return !i.extensions || !i.extensions[this.name] ? null : b
    ...
    extendMaterialParams(e, t) {
        ...
        const r = []
          , s = n.extensions[this.name];
        return s.anisotropyStrength !== void 0 && (t.anisotropy = s.anisotropyStrength),
...
class Lt {
    constructor(e) {
        this.name = R.EXT_MESHOPT_COMPRESSION,
        this.parser = e
    }
    loadBufferView(e) {
        ...
        if (i.extensions && i.extensions[this.name]) {
            ...
            return r.then(function(a) {
                ...
                return s.decodeGltfBufferAsync ? s.decodeGltfBufferAsync(l, u, f, n.mode, n.filter).then(function(h) {
                    return h.buffer
                }) : s.ready.then(function() {
                    const h = new ArrayBuffer(l * u);
                    return s.decodeGltfBuffer(new Uint8Array(h), l, u, f, n.mode, n.filter),
                    h
                })
            })
        } else
...
class wt {
    constructor(e) {
        this.name = R.EXT_MESH_GPU_INSTANCING,
        this.parser = e
    }
    createNodeMesh(e) {
        const t = this.parser.json
        ...
        const s = i.extensions[this.name].attributes
          ...
          , o = {};
        for (const c in s)
            a.push(this.parser.getDependency("accessor", s[c]).then(l => (o[c] = l,
            o[c])));
        ...
        Promise.all(a).then(c => {
            ...
            for (const p of u) {
                ...
                ge.prototype.copy.call(y, p),
                this.parser.assignFinalMaterial(y),
                h.push(y)
            }
            return l.isGroup ? (l.clear(),
            l.add(...h),
            l) : h[0]
        }
        ))
...
class Ct extends Ee {
    interpolate_(e, t, i, n) {
        ...
        return Nt.fromArray(r).normalize().toArray(r),
        r
    }
}
const A = {
...
function kt(d) {
    return d.DefaultMaterial === void 0 && (d.DefaultMaterial = new xe({
        color: 16777215,
        emissive: 0,
        metalness: 1,
        roughness: 1,
...
function k(d, e, t) {
    for (const i in t.extensions)
        d[i] === void 0 && (e.userData.gltfExtensions = e.userData.gltfExtensions || {},
...
function Pt(d, e, t) {
    ...
    return Promise.all([Promise.all(s), Promise.all(a), Promise.all(o)]).then(function(c) {
        const l = c[0]
          , u = c[1]
          , f = c[2];
        return i && (d.morphAttributes.position = l),
...
function Ft(d) {
    ...
    if (t ? e = "draco:" + t.bufferView + ":" + t.indices + ":" + Y(t.attributes) : e = d.indices + ":" + Y(d.attributes) + ":" + d.mode,
    d.targets !== void 0)
...
class Ut {
    constructor(e={}, t={}) {
        ...
        typeof createImageBitmap > "u" || i && n < 17 || r && s < 98 ? this.textureLoader = new Ne(this.options.manager) : this.textureLoader = new Ce(this.options.manager),
    ...
    parse(e, t) {
        ...
        Promise.all(this._invokeAll(function(s) {
            ...
            return k(r, a, n),
            S(a, n),
            Promise.all(i._invokeAll(function(o) {
    ...
    loadAccessor(e) {
        ...
        Promise.all(r).then(function(s) {
            ...
            if (h && h !== u) {
                ...
                let y = t.cache.get(x);
                y || (T = new c(a,g * h,n.count * h / l),
                y = new Oe(T,h / l),
                t.cache.add(x, y)),
                m = new tt(y,o,f % h / l,p)
            } else
                a === null ? T = new c(n.count * o) : T = new c(a,f,n.count * o),
                m = new G(T,o,p);
            if (n.sparse !== void 0) {
                const g = W.SCALAR
                ...
                a !== null && (m = new G(m.array.slice(),m.itemSize,m.normalized)),
                m.normalized = !1;
    ...
    loadTextureImage(e, t, i) {
        ...
        const c = this.loadImageSource(t, i).then(function(l) {
            ...
            return l.magFilter = ue[f.magFilter] || Z,
    ...
    loadImageSource(e, t) {
        ...
        const l = Promise.resolve(o).then(function(u) {
            ...
            S(u, s),
            u.userData.mimeType = s.mimeType || Ht(s.uri),
            u
        }).catch(function(u) {
    ...
    assignTexture(e, t, i, n) {
        ...
        return this.getDependency("texture", i.index).then(function(s) {
            if (!s)
                return null;
            if (i.texCoord !== void 0 && i.texCoord > 0 && (s = s.clone(),
            s.channel = i.texCoord),
            r.extensions[R.KHR_TEXTURE_TRANSFORM]) {
                ...
                if (a) {
                    ...
                    s = r.extensions[R.KHR_TEXTURE_TRANSFORM].extendTexture(s, a),
                    r.associations.set(s, o)
                }
            }
            return n !== void 0 && (s.colorSpace = n),
            e[t] = s,
            s
        })
    }
    assignFinalMaterial(e) {
        ...
        if (n || r || s) {
            ...
            r && (o.vertexColors = !0),
            s && (o.flatShading = !0),
            n && (o.normalScale && (o.normalScale.y *= -1),
    ...
    loadMaterial(e) {
        ...
        if (l === q.BLEND ? (a.transparent = !0,
        a.depthWrite = !1) : (a.transparent = !1,
        l === q.MASK && (a.alphaTest = r.alphaCutoff !== void 0 ? r.alphaCutoff : .5)),
        r.normalTexture !== void 0 && s !== v && (c.push(t.assignTexture(a, "normalMap", r.normalTexture)),
        a.normalScale = new pe(1,1),
        r.normalTexture.scale !== void 0)) {
            const u = r.normalTexture.scale;
            a.normalScale.set(u, u)
        }
        if (r.occlusionTexture !== void 0 && s !== v && (c.push(t.assignTexture(a, "aoMap", r.occlusionTexture)),
        ...
        return r.emissiveTexture !== void 0 && s !== v && c.push(t.assignTexture(a, "emissiveMap", r.emissiveTexture, C)),
        ...
        Promise.all(a).then(function(o) {
            ...
            for (let h = 0, p = l.length; h < p; h++) {
                ...
                if (m.mode === A.TRIANGLES || m.mode === A.TRIANGLE_STRIP || m.mode === A.TRIANGLE_FAN || m.mode === void 0)
                    ...
                    m.mode === A.TRIANGLE_STRIP ? g.geometry = ae(g.geometry, fe) : m.mode === A.TRIANGLE_FAN && (g.geometry = ae(g.geometry, Q));
                else if (m.mode === A.LINES)
                    g = new Ve(T,x);
                else if (m.mode === A.LINE_STRIP)
                    g = new ze(T,x);
                else if (m.mode === A.LINE_LOOP)
                    g = new Xe(T,x);
                else if (m.mode === A.POINTS)
                    g = new We(T,x);
                else
            ...
            if (u.length === 1)
                return r.extensions && k(n, u[0], r),
                u[0];
            const f = new z;
            r.extensions && k(n, f, r),
    ...
    loadCamera(e) {
        ...
        return i.type === "perspective" ? t = new qe(Ye.radToDeg(n.yfov),n.aspectRatio || 1,n.znear || 1,n.zfar || 2e6) : i.type === "orthographic" && (t = new Je(-n.xmag,n.xmag,n.ymag,-n.ymag,n.znear,n.zfar)),
        ...
        Promise.all(i).then(function(n) {
            ...
            for (let c = 0, l = s.length; c < l; c++) {
                ...
                if (u) {
                    a.push(u);
                    const f = new B;
                    r !== null && f.fromArray(r.array, c * 16),
                    o.push(f)
                } else
    ...
    loadAnimation(e) {
        ...
        for (let u = 0, f = n.channels.length; u < f; u++) {
            ...
            T.node !== void 0 && (s.push(this.getDependency("node", m)),
    ...
    _loadNodeShallow(e) {
        ...
        this.nodeCache[e] = Promise.all(a).then(function(c) {
            let l;
            if (r.isBone === !0 ? l = new $e : c.length > 1 ? l = new z : c.length === 1 ? l = c[0] : l = new ge,
            l !== c[0])
            ...
            return n.associations.get(l).nodes = e,
            l
        }),
        this.nodeCache[e]
    }
        ...
        return Promise.all(a).then(function(o) {
            ...
            const c = l => {
                ...
                for (const [f,h] of n.associations)
                    (f instanceof V || f instanceof se) && u.set(f, h);
                return l.traverse(f => {
    ...
    _createAnimationTracks(e, t, i, n, r) {
        const s = []
          ...
          , o = [];
        N[r.path] === N.weights ? e.traverse(function(f) {
...
function Gt(d, e, t) {
    ...
    if (i.POSITION !== void 0) {
        ...
        if (o !== void 0 && c !== void 0) {
            if (n.set(new P(o[0],o[1],o[2]), new P(c[0],c[1],c[2])),
            a.normalized) {
        ...
        for (let c = 0, l = r.length; c < l; c++) {
            ...
            if (u.POSITION !== void 0) {
                ...
                if (h !== void 0 && p !== void 0) {
                    if (o.setX(Math.max(Math.abs(h[0]), Math.abs(p[0]))),
...
function de(d, e, t) {
    ...
    return ee.workingColorSpace !== w && "COLOR_0"in i && console.warn(`THREE.GLTFLoader: Converting vertex colors from "srgb-linear" to "${ee.workingColorSpace}" not supported.`),
    S(d, e),
    Gt(d, e, t),
...
class Wt extends he {
    ...
    decodeGeometry(e, t) {
        ...
        const r = this.workerNextTaskID++
          , s = e.byteLength
          , a = this._getWorker(r, s).then(o => (n = o,
        new Promise( (c, l) => {
            n._callbacks[r] = {
                resolve: c,
                reject: l
    ...
    _createGeometry(e) {
        ...
        for (let i = 0; i < e.attributes.length; i++) {
            const n = e.attributes[i]
              ...
              , a = n.itemSize
              , o = new G(s,a);
            r === "color" && (this._assignVertexColorSpace(o, n.vertexColorSpace),
...
function jt() {
        ...
        case "decode":
            ...
            e.then(l => {
                ...
                try {
                    ...
                    h.index && p.push(h.index.array.buffer),
                    self.postMessage({
                        type: "decode",
                        id: a.id,
                        geometry: h
    ...
    function t(s, a, o, c) {
        ...
        if (p === s.TRIANGULAR_MESH)
            f = new s.Mesh,
            h = a.DecodeArrayToMesh(o, o.byteLength, f);
        else if (p === s.POINT_CLOUD)
            f = new s.PointCloud,
            h = a.DecodeArrayToPointCloud(o, o.byteLength, f);
        else
        ...
        for (const m in l) {
            ...
            if (c.useUniqueIDs)
                y = l[m],
                x = a.GetAttributeByUniqueId(f, y);
            else {
                if (y = a.GetAttributeId(f, s[l[m]]),
                y === -1)
                    continue;
                x = a.GetAttribute(f, y)
            }
            const _ = n(s, a, f, m, g, x);
            m === "color" && (_.vertexColorSpace = c.vertexColorSpace),
            T.attributes.push(_)
        }
        return p === s.TRIANGULAR_MESH && (T.index = i(s, a, f)),
        s.destroy(f),
        T
    }
    function i(s, a, o) {
...
const Yt = "/_astro/model-1.B_txL4GN.glb"
  , Jt = "/_astro/model-2.CJyUDGgt.glb";
function Qt(d) {
    ...
    d.group.position.set(e, d.position.y, d.position.z),
    d.group.rotation.set(d.rotate.x, d.rotate.y, d.rotate.z)
}
function Zt(d) {
    return {
