...
class p {
    ...
    init() {
        ...
        this.split = new i(this.text,{
            type: "lines",
            linesClass: "text-line"
        }),
        this.splitSecond = new i(this.text,{
            type: "lines"
        }),
        t.set(this.splitSecond.lines, {
            overflow: "clip",
            paddingBottom: "0.1em",
            marginBottom: "-0.1em"
        }),
        this.tl = t.timeline({
            ...
            paused: !0,
            onComplete: () => {
                window.innerWidth < 768 && (this.split.revert(),
                this.tl.kill())
            }
        }),
        ...
        this.tlScroll = e.create({
            trigger: this.instance,
            start: "top 80%",
            onEnter: () => this.tl.play()
        }),
        window.innerWidth > 768 && (this.tlScrollBack = e.create({
            trigger: this.instance,
            start: "top bottom",
