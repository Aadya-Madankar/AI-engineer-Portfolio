...
const c = m => {
    ...
    const i = t.timeline({
      ...
      , u = 1024;
    return t.matchMedia().add({
        isLarge: `(min-width: ${u}px)`,
        isSmall: `(max-width: ${u - 1}px)`
    }, n => {
...
class A {
    constructor(e, a, o) {
        ...
        this.quick = this.isMobile ? t.quickSetter(this.loaderPercentageParent, "y", "px") : t.quickSetter(this.loaderPercentageParent, "x", "px"),
        this.tl = t.timeline({
            paused: !0,
            defaults: {
                ease: "expo.inOut",
            ...
            onStart: async () => {
                ...
                await this.toLoad(o, this.main),
                await this.app.page.triggerLoad())
            }
            ,
            onComplete: () => this.complete()
        }),
        this.tl.fromTo(this.number, {
            value: 0
        }, {
            value: 88,
            onUpdate: () => this.update(this.number.value),
            onStart: () => {
                setTimeout( () => document.querySelector(".canvas-container").style.visibility = "visible", 100)
            }
        }).addLabel("start", ">"),
        this.tl.to(this.number, {
            value: 100,
            duration: 1,
            onUpdate: () => this.update(this.number.value)
        }).fromTo(this.loaderLineParent, {
            "--progress": 0
        }, {
            "--progress": 1,
            duration: .8
        }, "<80%").fromTo(this.fadeOut, {
            value: 0
        }, {
            value: 1,
            duration: 1.3,
            ...
            onStart: () => {
                ...
                this.main.getAttribute("data-transition-page") == "home" ? this.app.page.loader.tl.play() : this.main.getAttribute("data-transition-page") == "about" && this.app.page.loader.loadingTl.play()
            }
        }, "<").fromTo(this.navBody, {
            "--nav-blur-load": 0
        }, {
        ...
        window.addEventListener("resize", () => {
            ...
            this.isMobile = window.innerWidth <= 768,
            r !== this.isMobile && (this.quick = this.isMobile ? t.quickSetter(this.loaderPercentageParent, "y", "px") : t.quickSetter(this.loaderPercentageParent, "x", "px"),
            this.isMobile ? t.set(this.loaderPercentageParent, {
                x: 0
            }) : t.set(this.loaderPercentageParent, {
                y: 0
            })),
    ...
    complete() {
        ...
        this.main.getAttribute("data-transition-page") == "password" ? this.app.page.load() : this.main.getAttribute("data-transition-page") == "about" && (document.querySelector(".canvas-container").style.zIndex = 10),
        this.main.getAttribute("data-transition-page") == "home" && this.app.gl.loaderGradient && (this.app.gl.loaderGradient.material.dispose(),
    ...
    update(e) {
        this.loaderLine.style.setProperty("--progress", e / 100),
        this.loaderSpan.innerText = `${Math.round(e)}%`;
        ...
        if (!this.noLoader && this.main.getAttribute("data-transition-page") == "home" && this.app.loaderGradientAdded && !this.app.options.onceLoaded) {
