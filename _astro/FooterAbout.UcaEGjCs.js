...
class c {
    ...
    init() {
        this.tl = e.timeline({});
        const t = window.innerHeight * .5;
        this.tl.fromTo(this.instance.querySelector(".footer_img"), {
            y: -t
        }, {
            y: 0,
            ease: "none"
    ...
    resize() {
        this.destroyed || (this.tl.kill(),
        this.scroll.kill(),
        this.scrollModel?.kill(),
