import {_ as i} from "./Layout.astro_astro_type_script_index_0_lang.DqdvXA6r.js";
class o {
    constructor() {
        this.active = window.location.href.includes("debug"),
        this.gui = null,
        this.active && this.loadGui()
    }
    async loadGui() {
        this.gui = await i( () => import("./lil-gui.esm.DFUWXXp-.js"), []),
        this.gui = new this.gui.default;
        const t = document.querySelector(".lil-gui.autoPlace");
        if (t.style.setProperty("right", "0"),
        t.setAttribute("data-lenis-prevent", "true"),
        ...
        window.addEventListener("resize", () => {
            if (window.innerWidth <= 768) {
                if (t.style.setProperty("--width", "200px"),
                t.style.setProperty("--font-size", "10px"),
                t.style.setProperty("--input-font-size", "10px"),
                t.style.setProperty("--title-height", "20px"),
                t.style.setProperty("--widget-height", "16px"),
