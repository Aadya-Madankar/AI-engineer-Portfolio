const __vite__mapDeps = (i, m=__vite__mapDeps, d=(m.f || (m.f = ["_astro/World.BECZFbeu.js", "_astro/animationUtils.Bla-uf-4.js", "_astro/index.xlujcirQ.js", "_astro/CSSPlugin.pkypRvgD.js", "_astro/all.xlujcirQ.js", "_astro/ScrollTrigger.C4gmGO9R.js", "_astro/AnimateModel.B38_Ktv8.js", "_astro/Layout.astro_astro_type_script_index_0_lang.DqdvXA6r.js", "_astro/tempus.B_tY_6We.js", "_astro/World.ACdR9IeJ.js"]))) => i.map(i => d[i]);
import {E as Xl, _ as La} from "./Layout.astro_astro_type_script_index_0_lang.DqdvXA6r.js";
...
class Fe {
    ...
    clamp(e, t) {
        return this.x = Be(this.x, e.x, t.x),
        this.y = Be(this.y, e.y, t.y),
        this
    }
    clampScalar(e, t) {
        return this.x = Be(this.x, e, t),
...
class _i {
    ...
    multiplyQuaternions(e, t) {
        const n = e._x
          ...
          , c = t._z
          , h = t._w;
        return this._x = n * h + a * o + s * c - r * l,
...
class U {
    ...
    applyMatrix4(e) {
        ...
        return this.x = (r[0] * t + r[4] * n + r[8] * s + r[12]) * a,
    ...
    projectOnPlane(e) {
        return Vs.copy(this).projectOnVector(e),
        this.sub(Vs)
    }
    reflect(e) {
...
class Ie {
    ...
    setUvTransform(e, t, n, s, r, a, o) {
        const l = Math.cos(r)
          , c = Math.sin(r);
        return this.set(n * l, n * c, -n * (l * a + c * o) + a + e, -s * c, s * l, -s * (-c * a + l * o) + o + t, 0, 0, 1),
        this
    }
    scale(e, t) {
        return this.premultiply(ks.makeScale(e, t)),
        this
    }
    rotate(e) {
        return this.premultiply(ks.makeRotation(-e)),
        this
    }
    translate(e, t) {
        return this.premultiply(ks.makeTranslation(e, t)),
        this
    }
    makeTranslation(e, t) {
...
const Ya = new Ie().set(.4123908, .3575843, .1804808, .212639, .7151687, .0721923, .0193308, .1191948, .9505322)
  , Ka = new Ie().set(3.2409699, -1.5373832, -.4986108, -.9692436, 1.8759675, .0415551, .0556301, -.203977, 1.0569715);
function th() {
    const i = {
        enabled: !0,
        ...
        fromWorkingColorSpace: function(s, r) {
            return li("THREE.ColorManagement: .fromWorkingColorSpace() has been renamed to .workingToColorSpace()."),
            i.workingToColorSpace(s, r)
        },
        toWorkingColorSpace: function(s, r) {
            return li("THREE.ColorManagement: .toWorkingColorSpace() has been renamed to .colorSpaceToWorking()."),
...
const Ws = new U;
class mt extends gi {
    constructor(e=mt.DEFAULT_IMAGE, t=mt.DEFAULT_MAPPING, n=On, s=On, r=Zt, a=Bn, o=Ot, l=jt, c=mt.DEFAULT_ANISOTROPY, h=Mn) {
        super(),
        this.isTexture = !0,
        Object.defineProperty(this, "id", {
            value: sh++
...
class Ye {
    ...
    applyMatrix4(e) {
        const t = this.x
          ...
          , r = this.w
          , a = e.elements;
        return this.x = a[0] * t + a[4] * n + a[8] * s + a[12] * r,
    ...
    setAxisAngleFromRotationMatrix(e) {
        ...
        const l = e.elements
          ...
          , m = l[6]
          , d = l[10];
        if (Math.abs(h - f) < .01 && Math.abs(u - x) < .01 && Math.abs(_ - m) < .01) {
            if (Math.abs(h + f) < .1 && Math.abs(u + x) < .1 && Math.abs(_ + m) < .1 && Math.abs(c + p + d - 3) < .1)
...
class Tn {
    ...
    expandByObject(e, t=!1) {
        ...
        if (n !== void 0) {
            ...
            if (t === !0 && r !== void 0 && e.isInstancedMesh !== !0)
                ...
                Xi.copy(e.boundingBox)) : (n.boundingBox === null && n.computeBoundingBox(),
    ...
    intersectsSphere(e) {
        return this.clampPoint(e.center, Ht),
    ...
    intersectsTriangle(e) {
        ...
        mn.subVectors(Yn, qn),
        wn.subVectors(Xn, Yn);
        let t = [0, -pn.z, pn.y, 0, -mn.z, mn.y, 0, -wn.z, wn.y, pn.z, 0, -pn.x, mn.z, 0, -mn.x, wn.z, 0, -wn.x, -pn.y, pn.x, 0, -mn.y, mn.x, 0, -wn.y, wn.x, 0];
        return !Xs(t, Xn, qn, Yn, qi) || (t = [1, 0, 0, 0, 1, 0, 0, 0, 1],
        !Xs(t, Xn, qn, Yn, qi)) ? !1 : (Yi.crossVectors(pn, mn),
        t = [Yi.x, Yi.y, Yi.z],
        Xs(t, Xn, qn, Yn, qi))
    }
    clampPoint(e, t) {
    ...
    getBoundingSphere(e) {
        ...
        e.radius = this.getSize(Ht).length() * .5),
        e
    }
    intersect(e) {
...
class fn {
    ...
    expandByPoint(e) {
        ...
        if (t > this.radius * this.radius) {
            const n = Math.sqrt(t)
              , s = (n - this.radius) * .5;
            this.center.addScaledVector(Ei, s / n),
            this.radius += s
        }
        return this
    }
    union(e) {
        ...
        this) : (this.center.equals(e.center) === !0 ? this.radius = Math.max(this.radius, e.radius) : (qs.subVectors(e.center, this.center).setLength(e.radius),
...
class Ls {
    ...
    distanceSqToSegment(e, t, n, s) {
        Ys.copy(e).add(t).multiplyScalar(.5),
        Ki.copy(t).sub(e).normalize(),
        gn.copy(this.origin).sub(Ys);
        ...
        if (h > 0)
            ...
            u >= 0)
                ...
                f <= -_ ? (u = Math.max(0, -(-a * r + o)),
                f = u > 0 ? -r : Math.min(Math.max(-r, -l), r),
                p = -u * u + f * (f + 2 * l) + c) : f <= _ ? (u = 0,
                f = Math.min(Math.max(-r, -l), r),
                p = f * (f + 2 * l) + c) : (u = Math.max(0, -(a * r + o)),
                f = u > 0 ? r : Math.min(Math.max(-r, -l), r),
                p = -u * u + f * (f + 2 * l) + c);
        else
            f = a > 0 ? -r : r,
        ...
        s && s.copy(Ys).addScaledVector(Ki, f),
        p
    }
    intersectSphere(e, t) {
    ...
    intersectBox(e, t) {
        ...
        s = (e.min.x - f.x) * c),
        h >= 0 ? (r = (e.min.y - f.y) * h,
        a = (e.max.y - f.y) * h) : (r = (e.max.y - f.y) * h,
        a = (e.min.y - f.y) * h),
...
class ze {
    ...
    lookAt(e, t, n) {
        ...
        return Rt.subVectors(e, t),
        Rt.lengthSq() === 0 && (Rt.z = 1),
        Rt.normalize(),
        _n.crossVectors(n, Rt),
        _n.lengthSq() === 0 && (Math.abs(n.z) === 1 ? Rt.x += 1e-4 : Rt.z += 1e-4,
        Rt.normalize(),
        _n.crossVectors(n, Rt)),
        _n.normalize(),
    ...
    determinant() {
        const e = this.elements
          ...
          , m = e[11]
          , d = e[15];
        return _ * (+r * l * u - s * c * u - r * o * f + n * c * f + s * o * p - n * l * p) + x * (+t * l * p - t * c * f + r * a * f - s * a * p + s * c * h - r * l * h) + m * (+t * c * u - t * o * p - r * a * u + n * a * p + r * o * h - n * c * h) + d * (-s * o * h - t * l * u + t * o * f + s * a * u - n * a * f + n * l * h)
    }
    transpose() {
        const e = this.elements;
        let t;
    ...
    makeRotationAxis(e, t) {
        const n = Math.cos(t)
          ...
          , c = r * a
          , h = r * o;
        return this.set(c * a + n, c * o - s * l, c * l + s * o, 0, c * o + s * l, h * o + n, h * l - s * a, 0, c * l - s * o, h * l + s * a, r * l * l + n, 0, 0, 0, 0, 1),
        this
    }
    makeScale(e, t, n) {
    ...
    makeShear(e, t, n, s, r, a) {
        return this.set(1, n, r, 0, e, 1, a, 0, t, s, 1, 0, 0, 0, 0, 1),
        this
    }
    compose(e, t, n) {
        const s = this.elements
...
class Jt {
    ...
    setFromRotationMatrix(e, t=this._order, n=!0) {
        ...
        case "ZXY":
            ...
            Math.abs(f) < .9999999 ? (this._y = Math.atan2(-u, p),
            this._z = Math.atan2(-a, c)) : (this._y = 0,
            this._z = Math.atan2(l, r));
            break;
        case "ZYX":
            this._y = Math.asin(-Be(u, -1, 1)),
            Math.abs(u) < .9999999 ? (this._x = Math.atan2(f, p),
    ...
    setFromQuaternion(e, t, n) {
        ...
        this.setFromRotationMatrix($a, t, n)
    }
...
class ct extends gi {
    ...
    translateOnAxis(e, t) {
        return ja.copy(e).applyQuaternion(this.quaternion),
    ...
    lookAt(e, t, n) {
        ...
        s && (nn.extractRotation(s.matrixWorld),
        $n.setFromRotationMatrix(nn),
    ...
    getWorldQuaternion(e) {
        return this.updateWorldMatrix(!0, !1),
        this.matrixWorld.decompose(Ti, e, uh),
        e
    }
    getWorldScale(e) {
        return this.updateWorldMatrix(!0, !1),
        this.matrixWorld.decompose(Ti, dh, e),
        e
    }
    getWorldDirection(e) {
        this.updateWorldMatrix(!0, !1);
...
class Wt {
    ...
    static getInterpolation(e, t, n, s, r, a, o, l) {
        return this.getBarycoord(e, t, n, s, rn) === null ? (l.x = 0,
        l.y = 0,
        "z"in l && (l.z = 0),
        "w"in l && (l.w = 0),
        null) : (l.setScalar(0),
        l.addScaledVector(r, rn.x),
        l.addScaledVector(a, rn.y),
        l.addScaledVector(o, rn.z),
        l)
    }
    static getInterpolatedAttribute(e, t, n, s, r, a) {
        return tr.setScalar(0),
        nr.setScalar(0),
        ir.setScalar(0),
    ...
    getArea() {
        return kt.subVectors(this.c, this.b),
        sn.subVectors(this.a, this.b),
        kt.cross(sn).length() * .5
    }
    getMidpoint(e) {
    ...
    closestPointToPoint(e, t) {
        ...
        if (x <= 0 && c >= 0 && _ <= 0)
            return o = c / (c - _),
            t.copy(n).addScaledVector(Jn, o);
        const m = h * _ - p * u;
        if (m <= 0 && u - h >= 0 && p - _ >= 0)
            return no.subVectors(r, s),
            o = (u - h) / (u - h + (p - _)),
            t.copy(s).addScaledVector(no, o);
        const d = 1 / (m + x + f);
        return a = x * d,
        o = f * d,
        t.copy(n).addScaledVector(jn, a).addScaledVector(Jn, o)
    }
    equals(e) {
...
class Ne {
    ...
    setHSL(e, t, n, s=Ge.workingColorSpace) {
        ...
        return Ge.colorSpaceToWorking(this, s),
        this
    }
    setStyle(e, t=Ft) {
        function n(r) {
    ...
    getHex(e=Ft) {
        return Ge.workingToColorSpace(_t.copy(this), e),
        Math.round(Be(_t.r * 255, 0, 255)) * 65536 + Math.round(Be(_t.g * 255, 0, 255)) * 256 + Math.round(Be(_t.b * 255, 0, 255))
    }
    getHexString(e=Ft) {
    ...
    getRGB(e, t=Ge.workingColorSpace) {
        return Ge.workingToColorSpace(_t.copy(this), t),
        e.r = _t.r,
        e.g = _t.g,
        e.b = _t.b,
        e
    ...
    offsetHSL(e, t, n) {
        ...
        this.setHSL(vn.h + e, vn.s + t, vn.l + n)
    }
    add(e) {
        return this.r += e.r,
        this.g += e.g,
...
class Bt {
    ...
    getComponent(e, t) {
        ...
        return this.normalized && (n = Gt(n, this.array)),
        n
    }
    setComponent(e, t, n) {
        return this.normalized && (n = $e(n, this.array)),
    ...
    setX(e, t) {
        return this.normalized && (t = $e(t, this.array)),
    ...
    toJSON() {
        ...
        this.usage !== oa && (e.usage = this.usage),
        e
    }
}
class _l extends Bt {
...
class Yt extends gi {
    ...
    setIndex(e) {
        return Array.isArray(e) ? this.index = new (dl(e) ? vl : _l)(e,1) : this.index = e,
        this
    }
    setIndirect(e) {
    ...
    applyQuaternion(e) {
        return Nt.makeRotationFromQuaternion(e),
        this.applyMatrix4(Nt),
        this
    }
    rotateX(e) {
        return Nt.makeRotationX(e),
        this.applyMatrix4(Nt),
        this
    }
    rotateY(e) {
        return Nt.makeRotationY(e),
        this.applyMatrix4(Nt),
        this
    }
    rotateZ(e) {
        return Nt.makeRotationZ(e),
        this.applyMatrix4(Nt),
        this
    }
    translate(e, t, n) {
        return Nt.makeTranslation(e, t, n),
        this.applyMatrix4(Nt),
        this
    }
    scale(e, t, n) {
        return Nt.makeScale(e, t, n),
        this.applyMatrix4(Nt),
        this
    }
    lookAt(e) {
        ...
        if (e !== void 0) {
            ...
            t)
                for (let n = 0, s = t.length; n < s; n++) {
                    ...
                    this.morphTargetsRelative ? (pt.addVectors(this.boundingBox.min, Ct.min),
                    this.boundingBox.expandByPoint(pt),
                    pt.addVectors(this.boundingBox.max, Ct.max),
                    this.boundingBox.expandByPoint(pt)) : (this.boundingBox.expandByPoint(Ct.min),
        ...
        if (e) {
            ...
            t)
                for (let r = 0, a = t.length; r < a; r++) {
                    ...
                    this.morphTargetsRelative ? (pt.addVectors(Ct.min, bi.min),
                    Ct.expandByPoint(pt),
                    pt.addVectors(Ct.max, bi.max),
                    Ct.expandByPoint(pt)) : (Ct.expandByPoint(bi.min),
                    Ct.expandByPoint(bi.max))
                }
            Ct.getCenter(n);
            let s = 0;
    ...
    computeTangents() {
        ...
        function d(N, y, M) {
            ...
            isFinite(P) && (x.copy(h).multiplyScalar(_.y).addScaledVector(u, -p.y).multiplyScalar(P),
        ...
        for (let N = 0, y = b.length; N < y; ++N) {
            ...
            for (let z = P, W = P + q; z < W; z += 3)
                d(e.getX(z + 0), e.getX(z + 1), e.getX(z + 2))
        }
        const T = new U
          , S = new U
          , I = new U
        ...
        function C(N) {
            ...
            const y = o[N];
            T.copy(y),
            T.sub(I.multiplyScalar(I.dot(y))).normalize(),
            S.crossVectors(w, y);
...
class Dt extends ct {
    ...
    getVertexPosition(e, t) {
        ...
        if (r && o) {
            ...
            for (let l = 0, c = r.length; l < c; l++) {
                const h = o[l]
                  , u = r[l];
                h !== 0 && (ar.fromBufferAttribute(u, e),
                a ? ss.addScaledVector(ar, h) : ss.addScaledVector(ar.sub(t), h))
            }
            t.add(ss)
        }
        return t
    ...
    raycast(e, t) {
        ...
        !(es.containsPoint(Cn.origin) === !1 && (Cn.intersectSphere(es, so) === null || Cn.origin.distanceToSquared(so) > (e.far - e.near) ** 2)) && (io.copy(r).invert(),
...
function _h(i, e, t, n, s, r, a, o) {
    let l;
    if (e.side === Tt ? l = n.intersectTriangle(a, r, s, !0, o) : l = n.intersectTriangle(s, r, a, e.side === En, o),
    l === null)
        return null;
    rs.copy(o),
...
function as(i, e, t, n, s, r, a, o, l, c) {
    ...
    i.getVertexPosition(l, ns),
    i.getVertexPosition(c, is);
    ...
    if (h) {
        ...
        a && (h.normal = Wt.getInterpolatedAttribute(a, o, l, c, u, new U),
        ...
        Wt.getNormal(ts, ns, is, f.normal),
        h.face = f,
        h.barycoord = u
    }
    return h
...
class Et extends Ml {
    ...
    setFocalLength(e) {
        ...
        this.fov = pi * 2 * Math.atan(t),
        this.updateProjectionMatrix()
    }
    getFocalLength() {
        const e = Math.tan(Di * .5 * this.fov);
        return .5 * this.getFilmHeight() / e
    }
    getEffectiveFOV() {
        return pi * 2 * Math.atan(Math.tan(Di * .5 * this.fov) / this.zoom)
    }
    getFilmWidth() {
    ...
    getViewBounds(e, t, n) {
        xn.set(-1, -1, .5).applyMatrix4(this.projectionMatrixInverse),
        t.set(xn.x, xn.y).multiplyScalar(-e / xn.z),
        xn.set(1, 1, .5).applyMatrix4(this.projectionMatrixInverse),
        n.set(xn.x, xn.y).multiplyScalar(-e / xn.z)
    }
    getViewSize(e, t) {
        return this.getViewBounds(e, ao, oo),
        t.subVectors(oo, ao)
    }
    ...
    updateProjectionMatrix() {
        const e = this.near;
        let t = e * Math.tan(Di * .5 * this.fov) / this.zoom
          , n = 2 * t
          , s = this.aspect * n
          , r = -.5 * s;
        const a = this.view;
...
class Eh extends Hn {
    ...
    fromEquirectangularTexture(e, t) {
        ...
        const a = new Dt(s,r)
          , o = t.minFilter;
        return t.minFilter === Bn && (t.minFilter = Zt),
...
class or {
    ...
    getHandSpace() {
        return this._hand === null && (this._hand = new os,
    ...
    getTargetRaySpace() {
        return this._targetRay === null && (this._targetRay = new os,
    ...
    getGripSpace() {
        return this._grip === null && (this._grip = new os,
        ...
        if (e && t.session.visibilityState !== "visible-blurred") {
            if (c && e.hand) {
                ...
                const h = c.joints["index-finger-tip"]
                  ...
                  , p = .02
                  , _ = .005;
                c.inputState.pinching && f > p + _ ? (c.inputState.pinching = !1,
                this.dispatchEvent({
                    type: "pinchend",
                    handedness: e.handedness,
                    target: this
                })) : !c.inputState.pinching && f <= p - _ && (c.inputState.pinching = !0,
                this.dispatchEvent({
                    type: "pinchstart",
                    handedness: e.handedness,
                    target: this
            ...
            o !== null && (s = t.getPose(e.targetRaySpace, n),
            s === null && r !== null && (s = r),
...
class ug extends Dt {
    ...
    computeBoundingBox() {
        ...
        for (let n = 0; n < t.count; n++)
            this.getVertexPosition(n, ls),
            this.boundingBox.expandByPoint(ls)
    }
    computeBoundingSphere() {
        const e = this.geometry;
        this.boundingSphere === null && (this.boundingSphere = new fn),
        ...
        for (let n = 0; n < t.count; n++)
            this.getVertexPosition(n, ls),
            this.boundingSphere.expandByPoint(ls)
    }
    copy(e, t) {
        return super.copy(e, t),
    ...
    raycast(e, t) {
        ...
        lr.applyMatrix4(s),
        e.ray.intersectsSphere(lr) !== !1 && (fo.copy(s).invert(),
        cr.copy(e.ray).applyMatrix4(fo),
        !(this.boundingBox !== null && cr.intersectsBox(this.boundingBox) === !1) && this._computeIntersections(e, t, cr)))
    }
    getVertexPosition(e, t) {
    ...
    updateMatrixWorld(e) {
        super.updateMatrixWorld(e),
        this.bindMode === Ba ? this.bindMatrixInverse.copy(this.matrixWorld).invert() : this.bindMode === yc ? this.bindMatrixInverse.copy(this.bindMatrix).invert() : console.warn("THREE.SkinnedMesh: Unrecognized bindMode: " + this.bindMode)
    }
...
class Tl {
    ...
    fromJSON(e, t) {
        ...
        for (let n = 0, s = e.bones.length; n < s; n++) {
            const r = e.bones[n];
            let a = t[r];
            a === void 0 && (console.warn("THREE.Skeleton: No bone found with UUID:", r),
            a = new wh),
            this.bones.push(a),
...
class dg extends Dt {
    ...
    computeBoundingBox() {
        ...
        this.boundingBox.makeEmpty();
        for (let n = 0; n < t; n++)
            this.getMatrixAt(n, ni),
            _o.copy(e.boundingBox).applyMatrix4(ni),
            this.boundingBox.union(_o)
    }
    computeBoundingSphere() {
        const e = this.geometry
          , t = this.count;
        ...
        for (let n = 0; n < t; n++)
            this.getMatrixAt(n, ni),
            wi.copy(e.boundingSphere).applyMatrix4(ni),
    ...
    raycast(e, t) {
        ...
        Ai.material !== void 0 && (this.boundingSphere === null && this.computeBoundingSphere(),
        wi.copy(this.boundingSphere),
        wi.applyMatrix4(n),
        e.ray.intersectsSphere(wi) !== !1))
            for (let r = 0; r < s; r++) {
                this.getMatrixAt(r, ni),
                go.multiplyMatrices(n, ni),
                Ai.matrixWorld = go,
                Ai.raycast(e, cs);
    ...
    setColorAt(e, t) {
        this.instanceColor === null && (this.instanceColor = new mo(new Float32Array(this.instanceMatrix.count * 3).fill(1),3)),
...
class Ma {
    ...
    setFromProjectionMatrix(e, t=cn) {
        const n = this.planes
          ...
          , T = s[14]
          , S = s[15];
        if (n[0].setComponents(l - r, f - c, m - p, S - d).normalize(),
        ...
        t === cn)
            ...
            n[5].setComponents(o, u, x, T).normalize();
        else
    ...
    intersectsSprite(e) {
        ...
        return Pn.radius = .7071067811865476 + t,
    ...
    intersectsBox(e) {
        ...
        for (let n = 0; n < 6; n++) {
            const s = t[n];
            if (hs.x = s.normal.x > 0 ? e.max.x : e.min.x,
...
function ds(i, e, t, n, s, r, a) {
    ...
    if (Rs.fromBufferAttribute(o, s),
    Cs.fromBufferAttribute(o, r),
    t.distanceSqToSegment(Rs, Cs, ur, xo) > n)
        return;
    ...
    raycast(e, t) {
        ...
        if (c !== null) {
            ...
            for (let _ = f, x = p; _ < x; _++) {
                const m = c.getX(_);
                ps.fromBufferAttribute(u, m),
                Eo(ps, m, l, s, e, t, this)
            }
        } else {
            const f = Math.max(0, a.start)
              , p = Math.min(u.count, a.start + a.count);
            for (let _ = f, x = p; _ < x; _++)
                ps.fromBufferAttribute(u, _),
                Eo(ps, _, l, s, e, t, this)
        }
    }
    updateMorphTargets() {
        const t = this.geometry.morphAttributes
    ...
    constructor(e=1, t=32, n=16, s=0, r=Math.PI * 2, a=0, o=Math.PI) {
        ...
        for (let d = 0; d <= n; d++) {
            const b = []
              , T = d / n;
            let S = 0;
            d === 0 && a === 0 ? S = .5 / t : d === n && l === Math.PI && (S = -.5 / t);
            for (let I = 0; I <= t; I++) {
                const w = I / t;
        ...
        for (let d = 0; d < n; d++)
            for (let b = 0; b < t; b++) {
                const T = h[d][b + 1]
                  ...
                  , I = h[d + 1][b]
                  , w = h[d + 1][b + 1];
                (d !== 0 || a > 0) && p.push(T, S, w),
                (d !== n - 1 || l < Math.PI) && p.push(S, I, w)
            }
        this.setIndex(p),
        this.setAttribute("position", new bt(_,3)),
        this.setAttribute("normal", new bt(x,3)),
...
class Vh extends Us {
    ...
    interpolate_(e, t, n, s) {
        const r = this.resultBuffer
          ...
          , m = x * _
          , d = -f * m + 2 * f * x - f * _
          , b = (1 + f) * m + (-1.5 - 2 * f) * x + (-.5 + f) * _ + 1
          , T = (-1 - p) * m + (1.5 + p) * x + .5 * _
          , S = p * m - p * x;
        for (let I = 0; I !== o; ++I)
            r[I] = d * a[h + I] + b * a[c + I] + T * a[l + I] + S * a[u + I];
        return r
    }
}
class kh extends Us {
...
class Yh {
    constructor(e, t, n) {
        ...
        this.itemStart = function(h) {
            o++,
            r === !1 && s.onStart !== void 0 && s.onStart(h, a, o),
            r = !0
        }
        ,
    ...
    load(e, t, n, s) {
        ...
        fetch(a).then(c => {
            if (c.status === 200 || c.status === 0) {
                ...
                throw new $h(`fetch for "${c.url}" responded with ${c.status}: ${c.statusText}`,c)
        }
        ).then(c => {
            switch (l) {
            case "arraybuffer":
...
class jh extends ya {
    ...
    updateMatrices(e) {
        const t = this.camera
          ...
          , r = e.distance || t.far;
        (n !== t.fov || s !== t.aspect || r !== t.far) && (t.fov = n,
        t.aspect = s,
        t.far = r,
...
class Jh extends ya {
    constructor() {
        super(new Et(90,1,.5,500)),
        this.isPointLightShadow = !0,
        this._frameExtents = new Fe(4,2),
        this._viewportCount = 6,
        this._viewports = [new Ye(2,1,1,1), new Ye(0,1,1,1), new Ye(3,1,1,1), new Ye(1,1,1,1), new Ye(3,0,1,1), new Ye(1,0,1,1)],
...
class Eg extends Vi {
    ...
    load(e, t, n, s) {
        ...
        const l = fetch(e, o).then(function(c) {
            ...
            return hn.add(`image-bitmap:${e}`, c),
            t && t(c),
            r.manager.itemEnd(e),
            c
        }).catch(function(c) {
            s && s(c),
            pr.set(l, c),
            hn.remove(`image-bitmap:${e}`),
            r.manager.itemError(e),
            r.manager.itemEnd(e)
        });
        hn.add(`image-bitmap:${e}`, l),
        r.manager.itemStart(e)
    }
}
class eu extends Et {
...
class cu {
    constructor(e, t, n) {
        ...
        this._targetGroup = e,
        this._bindings = e.subscribe_(t, s)
    }
    getValue(e, t) {
        this.bind();
...
class Je {
    ...
    static parseTrackName(e) {
        ...
        if (s !== void 0 && s !== -1) {
            ...
            lu.indexOf(r) !== -1 && (n.nodeName = n.nodeName.substring(0, s),
            n.objectName = r)
        }
    ...
    bind() {
        ...
        if (e || (e = Je.findNode(this.rootNode, t.nodeName),
        this.node = e),
        ...
        if (r !== void 0) {
            ...
            this.resolvedProperty = a) : this.propertyName = s;
...
class Tg extends Lh {
    constructor(e=1) {
        const t = [0, 0, 0, e, 0, 0, 0, 0, 0, 0, e, 0, 0, 0, 0, 0, 0, e]
          ...
          , s = new Yt;
        s.setAttribute("position", new bt(t,3)),
        s.setAttribute("color", new bt(n,3));
        const r = new bl({
            vertexColors: !0,
            toneMapped: !1
        });
    ...
    function n(o, l, c) {
        ...
        u.length === 0)
            ...
            for (let p = 1; p < u.length; p++) {
                const _ = u[f]
                  , x = u[p];
                x.start <= _.start + _.count + 1 ? _.count = Math.max(_.count, x.start + x.count - _.start) : (++f,
                u[f] = x)
            }
            u.length = f + 1;
...
void main() {
  ...
  , $t = {
    ...
    lambert: {
        uniforms: St([ie.common, ie.specularmap, ie.envmap, ie.aomap, ie.lightmap, ie.emissivemap, ie.bumpmap, ie.normalmap, ie.displacementmap, ie.fog, ie.lights, {
            emissive: {
                value: new Ne(0)
            }
        }]),
    ...
    standard: {
        uniforms: St([ie.common, ie.envmap, ie.aomap, ie.lightmap, ie.emissivemap, ie.bumpmap, ie.normalmap, ie.displacementmap, ie.roughnessmap, ie.metalnessmap, ie.fog, ie.lights, {
            emissive: {
                value: new Ne(0)
            },
            roughness: {
    ...
    toon: {
        uniforms: St([ie.common, ie.aomap, ie.lightmap, ie.emissivemap, ie.bumpmap, ie.normalmap, ie.displacementmap, ie.gradientmap, ie.fog, ie.lights, {
            emissive: {
                value: new Ne(0)
            }
        }]),
    ...
    matcap: {
        uniforms: St([ie.common, ie.bumpmap, ie.normalmap, ie.displacementmap, ie.fog, {
            matcap: {
                value: null
            }
        }]),
    ...
    points: {
        uniforms: St([ie.points, ie.fog]),
        vertexShader: Ue.points_vert,
        fragmentShader: Ue.points_frag
    },
    dashed: {
        uniforms: St([ie.common, ie.fog, {
            scale: {
                value: 1
            },
            dashSize: {
    ...
    normal: {
        uniforms: St([ie.common, ie.bumpmap, ie.normalmap, ie.displacementmap, {
            opacity: {
                value: 1
            }
        }]),
...
$t.physical = {
    uniforms: St([$t.standard.uniforms, {
        clearcoat: {
            value: 0
        },
        clearcoatMap: {
...
function Yf(i, e, t, n, s, r, a) {
    ...
    function _(T) {
        ...
        return S && S.isTexture && (S = (T.backgroundBlurriness > 0 ? t : e).get(S)),
        S
    }
    function x(T) {
        let S = !1;
        ...
        w === "additive" ? n.buffers.color.setClear(0, 0, 0, 1, a) : w === "alpha-blend" && n.buffers.color.setClear(0, 0, 0, 0, a),
    ...
    function m(T, S) {
        const I = _(S);
        I && (I.isCubeTexture || I.mapping === Is) ? (h === void 0 && (h = new Dt(new zi(1,1,1),new dn({
        ...
        Dn.y *= -1,
        Dn.z *= -1,
        I.isCubeTexture && I.isRenderTargetTexture === !1 && (Dn.y *= -1,
        Dn.z *= -1),
        ...
        (u !== I || f !== I.version || p !== i.toneMapping) && (h.material.needsUpdate = !0,
        u = I,
        f = I.version,
        p = i.toneMapping),
        h.layers.enableAll(),
        T.unshift(h, h.geometry, h.material, 0, 0, null)) : I && I.isTexture && (c === void 0 && (c = new Dt(new Hi(2,2),new dn({
        ...
        (u !== I || f !== I.version || p !== i.toneMapping) && (c.material.needsUpdate = !0,
        u = I,
        f = I.version,
        p = i.toneMapping),
        c.layers.enableAll(),
    ...
    function d(T, S) {
        T.getRGB(gs, xl(i)),
        n.buffers.color.setClear(gs.r, gs.g, gs.b, S, a)
    }
    function b() {
...
function Kf(i, e) {
    ...
    function p(M, P, q, z) {
        ...
        for (const H in ee)
            if (ee[H].location >= 0) {
                const ue = W[H];
                let Se = j[H];
                if (Se === void 0 && (H === "instanceMatrix" && M.instanceMatrix && (Se = M.instanceMatrix),
    ...
    function _(M, P, q, z) {
        ...
        for (const H in ee)
            if (ee[H].location >= 0) {
                let ue = j[H];
                ue === void 0 && (H === "instanceMatrix" && M.instanceMatrix && (ue = M.instanceMatrix),
                H === "instanceColor" && M.instanceColor && (ue = M.instanceColor));
                const Se = {};
                Se.attribute = ue,
                ue && ue.data && (Se.data = ue.data),
                W[H] = Se,
                k++
            }
        r.attributes = W,
    ...
    function d(M, P) {
        ...
        z[M] = 1),
        W[M] !== P && (i.vertexAttribDivisor(M, P),
        W[M] = P)
    }
    function b() {
        const M = r.newAttributes
        ...
        for (let q = 0, z = P.length; q < z; q++)
            P[q] !== M[q] && (i.disableVertexAttribArray(q),
            P[q] = 0)
    }
    ...
    function S(M, P, q, z) {
        ...
        for (const ee in j) {
            ...
            if (H.location >= 0) {
                let oe = W[ee];
                if (oe === void 0 && (ee === "instanceMatrix" && M.instanceMatrix && (oe = M.instanceMatrix),
                    ...
                    if (oe.isInterleavedBufferAttribute) {
                        ...
                        if (le.isInstancedInterleavedBuffer) {
                            for (let we = 0; we < H.locationSize; we++)
                                d(H.location + we, le.meshPerAttribute);
                            M.isInstancedMesh !== !0 && z._maxInstanceCount === void 0 && (z._maxInstanceCount = le.meshPerAttribute * le.count)
                        } else
                            for (let we = 0; we < H.locationSize; we++)
                                m(H.location + we);
                        ...
                        if (oe.isInstancedBufferAttribute) {
                            for (let le = 0; le < H.locationSize; le++)
                                d(H.location + le, oe.meshPerAttribute);
                            M.isInstancedMesh !== !0 && z._maxInstanceCount === void 0 && (z._maxInstanceCount = oe.meshPerAttribute * oe.count)
                        } else
                            for (let le = 0; le < H.locationSize; le++)
                                m(H.location + le);
                        i.bindBuffer(i.ARRAY_BUFFER, Qe);
...
function Jf(i) {
    let e = new WeakMap;
    function t(a, o) {
        return o === Pr ? a.mapping = ui : o === Dr && (a.mapping = di),
        a
    }
    function n(a) {
        if (a && a.isTexture) {
...
const Un = (1 + Math.sqrt(5)) / 2
  , si = 1 / Un
  , Do = [new U(-Un,si,0), new U(Un,si,0), new U(-si,0,Un), new U(si,0,Un), new U(0,Un,-si), new U(0,Un,si), new U(-1,1,-1), new U(1,1,-1), new U(-1,1,1), new U(1,1,1)]
  , Qf = new U;
class Io {
    constructor(e) {
        this._renderer = e,
    ...
    _fromTexture(e, t) {
        e.mapping === ui || e.mapping === di ? this._setSize(e.image.length === 0 ? 16 : e.image[0].width || e.image[0].image.width) : this._setSize(e.image.width / 4),
        gr = this._renderer.getRenderTarget(),
        _r = this._renderer.getActiveCubeFace(),
        vr = this._renderer.getActiveMipmapLevel(),
        xr = this._renderer.xr.enabled,
    ...
    _allocateTargets() {
        ...
        if (this._pingPongRenderTarget === null || this._pingPongRenderTarget.width !== e || this._pingPongRenderTarget.height !== t) {
            ...
            this._pingPongRenderTarget = Lo(e, t, n);
    ...
    _sceneToCubeUV(e, t, n, s, r) {
        ...
        for (let b = 0; b < 6; b++) {
            ...
            l.lookAt(r.x + h[b], r.y, r.z)) : T === 1 ? (l.up.set(0, 0, c[b]),
            l.position.set(r.x, r.y, r.z),
            l.lookAt(r.x, r.y + h[b], r.z)) : (l.up.set(0, c[b], 0),
            l.position.set(r.x, r.y, r.z),
            l.lookAt(r.x, r.y, r.z + h[b]));
            const S = this._cubeSize;
            _s(s, T * S, b > 2 ? S : 0, S, S),
            u.setRenderTarget(s),
            m && u.render(x, l),
            u.render(e, l)
        }
    ...
    _textureToCubeUV(e, t) {
        ...
        s ? (this._cubemapMaterial === null && (this._cubemapMaterial = No()),
        this._cubemapMaterial.uniforms.flipEnvMap.value = e.isRenderTargetTexture === !1 ? -1 : 1) : this._equirectMaterial === null && (this._equirectMaterial = Uo());
    ...
    _halfBlur(e, t, n, s, r, a, o) {
        ...
        m > Fn && console.warn(`sigmaRadians, ${r}, is too large and will clip, as it requested ${m} samples when the maximum is set to ${Fn}`);
        const d = [];
        let b = 0;
        for (let C = 0; C < Fn; ++C) {
            const N = C / x
    ...
    function n(o) {
        if (o && o.isTexture) {
            ...
            if (c || h) {
                ...
                {
                    const p = o.image;
                    return c && p && p.height > 0 || h && p && s(p) ? (t === null && (t = new Io(i)),
...
function ip(i) {
    ...
    return {
        ...
        get: function(n) {
            const s = t(n);
            return s === null && li("THREE.WebGLRenderer: " + n + " extension not supported."),
            s
        }
    }
}
...
function rp(i, e, t) {
    ...
    function l(f, p) {
        i.drawElements(n, p, r, f * a),
        t.update(p, n, 1)
    }
    function c(f, p, _) {
        _ !== 0 && (i.drawElementsInstanced(n, p, r, f * a, _),
        t.update(p, n, _))
    }
    function h(f, p, _) {
        if (_ === 0)
    ...
    function r(a, o, l) {
        ...
        if (f === void 0 || f.count !== u) {
            ...
            let S = o.attributes.position.count * T
              , I = 1;
            S > e.maxTextureSize && (I = Math.ceil(S / e.maxTextureSize),
            S = e.maxTextureSize);
            ...
            for (let M = 0; M < u; M++) {
                ...
                for (let j = 0; j < P.count; j++) {
                    const k = j * N;
                    p === !0 && (s.fromBufferAttribute(P, j),
                    w[W + k + 0] = s.x,
                    w[W + k + 1] = s.y,
                    w[W + k + 2] = s.z,
                    w[W + k + 3] = 0),
                    _ === !0 && (s.fromBufferAttribute(q, j),
                    w[W + k + 4] = s.x,
                    w[W + k + 5] = s.y,
                    w[W + k + 6] = s.z,
                    w[W + k + 7] = 0),
                    x === !0 && (s.fromBufferAttribute(z, j),
                    w[W + k + 8] = s.x,
                    w[W + k + 9] = s.y,
                    w[W + k + 10] = s.z,
...
function fp(i, e) {
    ...
    if (n === void 0) {
        ...
        if (dt(t, n))
            return;
        Vo.set(n),
        i.uniformMatrix2fv(this.addr, !1, Vo),
        ft(t, n)
    }
}
function pp(i, e) {
    ...
    if (n === void 0) {
        ...
        if (dt(t, n))
            return;
        Ho.set(n),
        i.uniformMatrix3fv(this.addr, !1, Ho),
        ft(t, n)
    }
}
function mp(i, e) {
    ...
    if (n === void 0) {
        ...
        if (dt(t, n))
            return;
        zo.set(n),
        i.uniformMatrix4fv(this.addr, !1, zo),
        ft(t, n)
    }
}
function gp(i, e) {
...
function Tp(i, e, t) {
    ...
    n[0] = s);
    let r;
    this.type === i.SAMPLER_2D_SHADOW ? (Fo.compareFunction = ul,
    r = Fo) : r = Ll,
...
function Wp(i, e, t) {
    const n = this.cache
      , s = e.length
      , r = Fs(t, s);
    dt(n, r) || (i.uniform1iv(this.addr, r),
    ft(n, r));
    for (let a = 0; a !== s; ++a)
        t.setTexture2D(e[a] || Ll, r[a])
}
function Xp(i, e, t) {
    const n = this.cache
      , s = e.length
...
function Yp(i, e, t) {
    ...
    ft(n, r));
    for (let a = 0; a !== s; ++a)
        t.setTexture2DArray(e[a] || Ul, r[a])
}
function Kp(i) {
    switch (i) {
    case 5126:
...
function am(i) {
    return [i.extensionClipCullDistance ? "#extension GL_ANGLE_clip_cull_distance : require" : "", i.extensionMultiDraw ? "#extension GL_ANGLE_multi_draw : require" : ""].filter(Pi).join(`
`)
}
function om(i) {
    const e = [];
...
function pm(i) {
    ...
    return i.shadowMapType === Qo ? e = "SHADOWMAP_TYPE_PCF" : i.shadowMapType === $l ? e = "SHADOWMAP_TYPE_PCF_SOFT" : i.shadowMapType === on && (e = "SHADOWMAP_TYPE_VSM"),
    e
}
function mm(i) {
...
`)),
    ...
    a = Ko(a),
    o = Ko(o),
    t.isRawShaderMaterial !== !0 && (b = `#version 300 es
`,
    m = [p, "#define attribute in", "#define varying out", "#define texture2D texture"].join(`
`) + `
` + m,
    d = ["#define varying in", t.glslVersion === Ga ? "" : "layout(location = 0) out highp vec4 pc_fragColor;", t.glslVersion === Ga ? "" : "#define gl_FragColor pc_fragColor", "#define gl_FragDepthEXT gl_FragDepth", "#define texture2D texture", "#define textureCube texture", "#define texture2DProj textureProj", "#define texture2DLodEXT textureLod", "#define texture2DProjLodEXT textureProjLod", "#define textureCubeLodEXT textureLod", "#define texture2DGradEXT textureGrad", "#define texture2DProjGradEXT textureProjGrad", "#define textureCubeGradEXT textureGrad"].join(`
`) + `
` + d);
    const T = b + m + a
      , S = b + d + o
    ...
    s.attachShader(x, I),
    s.attachShader(x, w),
    t.index0AttributeName !== void 0 ? s.bindAttribLocation(x, 0, t.index0AttributeName) : t.morphTargets === !0 && s.bindAttribLocation(x, 0, "position"),
    s.linkProgram(x);
    function C(P) {
...
` + H)
                ...
                q !== "" ? console.warn("THREE.WebGLProgram: Program Info Log:", q) : (z === "" || W === "") && (k = !1);
            k && (P.diagnostics = {
                runnable: j,
                programLog: q,
                vertexShader: {
    ...
    this.getUniforms = function() {
        return N === void 0 && C(this),
        N
    }
    ;
    let y;
    this.getAttributes = function() {
        return y === void 0 && C(this),
        y
    }
    ;
    let M = t.rendererExtensionParallelShaderCompile === !1;
    return this.isReady = function() {
        return M === !1 && (M = s.getProgramParameter(x, Qp)),
        M
    }
    ,
...
function Em(i, e, t, n, s, r, a) {
    ...
    function m(y, M, P, q, z) {
        const W = q.fog
          ...
          , oe = _[y.type];
        y.precision !== null && (p = s.getMaxPrecision(y.precision),
        p !== y.precision && console.warn("THREE.WebGLProgram.getParameters:", y.precision, "not supported, using", p, "instead."));
        ...
        const nt = {
            ...
            decodeVideoTextureEmissive: Ve && y.emissiveMap.isVideoTexture === !0 && Ge.getTransfer(y.emissiveMap.colorSpace) === je,
    ...
    function d(y) {
        const M = [];
        if (y.shaderID ? M.push(y.shaderID) : (M.push(y.customVertexShaderID),
        M.push(y.customFragmentShaderID)),
        y.defines !== void 0)
            for (const P in y.defines)
                M.push(P),
                M.push(y.defines[P]);
        return y.isRawShaderMaterial === !1 && (b(M, y),
        T(M, y),
    ...
    function I(y, M) {
        ...
        return P === void 0 && (P = new xm(i,M,y,r),
        h.push(P)),
        P
    }
    function w(y) {
...
function jo() {
    ...
    function c(u, f) {
        t.length > 1 && t.sort(u || bm),
        n.length > 1 && n.sort(f || Zo),
        s.length > 1 && s.sort(f || Zo)
    }
    function h() {
...
function Am() {
    ...
    function e(n, s) {
        const r = i.get(n);
        let a;
        return r === void 0 ? (a = new jo,
        i.set(n, [a])) : s >= r.length ? (a = new jo,
        r.push(a)) : a = r[s],
        a
    }
    function t() {
    ...
    function o(c) {
        ...
        for (let y = 0, M = c.length; y < M; y++) {
            ...
            if (P.isAmbientLight)
                ...
                for (let k = 0; k < 9; k++)
                    n.probe[k].addScaledVector(P.sh.coefficients[k], z);
                C++
            } else if (P.isDirectionalLight) {
                const k = e.get(P);
                if (k.color.copy(P.color).multiplyScalar(P.intensity),
                P.castShadow) {
                    const ee = P.shadow
                      , H = t.get(P);
                ...
                const k = e.get(P);
                k.color.copy(q).multiplyScalar(z),
                k.halfWidth.set(P.width * .5, 0, 0),
                k.halfHeight.set(0, P.height * .5, 0),
                n.rectArea[m] = k,
                m++
        ...
        n.ambient[2] = f;
        const N = n.hash;
        (N.directionalLength !== p || N.pointLength !== _ || N.spotLength !== x || N.rectAreaLength !== m || N.hemiLength !== d || N.numDirectionalShadows !== b || N.numPointShadows !== T || N.numSpotShadows !== S || N.numSpotMaps !== I || N.numLightProbes !== C) && (n.directional.length = p,
        n.spot.length = x,
        n.rectArea.length = m,
        n.point.length = _,
        n.hemi.length = d,
...
function Im(i) {
    ...
    function t(s, r=0) {
        ...
        e.set(s, [o])) : r >= a.length ? (o = new Jo(i),
        a.push(o)) : o = a[r],
        o
    }
    function n() {
...
function Nm(i, e, t) {
    ...
    const _ = new Yt;
    _.setAttribute("position", new Bt(new Float32Array([-1, -1, .5, 3, -1, .5, -1, 3, .5]),3));
    const x = new Dt(_,f)
      , m = this;
    this.enabled = !1,
    this.autoUpdate = !0,
    ...
    this.render = function(w, C, N) {
        ...
        for (let j = 0, k = w.length; j < k; j++) {
            ...
            if (s.multiply(oe),
            r.copy(H.mapSize),
            (s.x > h || s.y > h) && (s.x > h && (r.x = Math.floor(h / oe.x),
            s.x = r.x * oe.x,
            H.mapSize.x = r.x),
            s.y > h && (r.y = Math.floor(h / oe.y),
            s.y = r.y * oe.y,
            H.mapSize.y = r.y)),
            H.map === null || z === !0 || W === !0) {
                const Se = this.type !== on ? {
                    minFilter: It,
                    magFilter: It
                } : {};
            ...
            H.isPointLightShadow !== !0 && this.type === on && b(H, N),
            H.needsUpdate = !1
        }
        d = this.type,
        m.needsUpdate = !1,
        i.setRenderTarget(y, M, P)
    }
    ;
    function b(w, C) {
        const N = e.update(x);
    ...
    function T(w, C, N, y) {
        ...
        i.localClippingEnabled && C.clipShadows === !0 && Array.isArray(C.clippingPlanes) && C.clippingPlanes.length !== 0 || C.displacementMap && C.displacementScale !== 0 || C.alphaMap && C.alphaTest > 0 || C.map && C.alphaTest > 0 || C.alphaToCoverage === !0) {
            const q = M.uuid
              , z = C.uuid;
            let W = c[q];
            W === void 0 && (W = {},
        ...
        if (M.visible = C.visible,
        M.wireframe = C.wireframe,
        y === on ? M.side = C.shadowSide !== null ? C.shadowSide : C.side : M.side = C.shadowSide !== null ? C.shadowSide : u[C.side],
        M.alphaMap = C.alphaMap,
        M.alphaTest = C.alphaToCoverage === !0 ? .5 : C.alphaTest,
        M.map = C.map,
    ...
    function S(w, C, N, y, M) {
        if (w.visible === !1)
            return;
        if (w.layers.test(C.layers) && (w.isMesh || w.isLine || w.isPoints) && (w.castShadow || w.receiveShadow && M === on) && (!w.frustumCulled || n.intersectsObject(w))) {
...
function Om(i, e) {
    function t() {
        ...
        return {
            ...
            setClear: function(J, Y, fe, De, nt) {
                ...
                fe *= De),
                re.set(J, Y, fe, De),
                de.equals(re) === !1 && (i.clearColor(J, Y, fe, De),
                de.copy(re))
            },
            reset: function() {
                R = !1,
        ...
        return {
            setReversed: function(Y) {
                if (re !== Y) {
                    ...
                    Y ? fe.clipControlEXT(fe.LOWER_LEFT_EXT, fe.ZERO_TO_ONE_EXT) : fe.clipControlEXT(fe.LOWER_LEFT_EXT, fe.NEGATIVE_ONE_TO_ONE_EXT),
                    re = Y;
                    const De = J;
                    J = null,
                    this.setClear(De)
    ...
    function s() {
        ...
        return {
            ...
            setMask: function(Ke) {
                re !== Ke && !R && (i.stencilMask(Ke),
                re = Ke)
            },
            setFunc: function(Ke, zt, Qt) {
                (Z !== Ke || de !== zt || J !== Qt) && (i.stencilFunc(Ke, zt, Qt),
                Z = Ke,
                de = zt,
                J = Qt)
            },
            setOp: function(Ke, zt, Qt) {
                (Y !== Ke || fe !== zt || De !== Qt) && (i.stencilOp(Ke, zt, Qt),
                Y = Ke,
                fe = zt,
                De = Qt)
            },
    ...
    H.indexOf("WebGL") !== -1 ? (ee = parseFloat(/^WebGL (\d)/.exec(H)[1]),
    k = ee >= 1) : H.indexOf("OpenGL ES") !== -1 && (ee = parseFloat(/^OpenGL ES (\d)/.exec(H)[1]),
    k = ee >= 2);
    let oe = null
      , ue = {};
    ...
    function te(R, re, Z, de) {
        ...
        for (let fe = 0; fe < Z; fe++)
            R === i.TEXTURE_3D || R === i.TEXTURE_2D_ARRAY ? i.texImage3D(re, 0, i.RGBA, 1, 1, de, 0, i.RGBA, i.UNSIGNED_BYTE, J) : i.texImage2D(re + fe, 0, i.RGBA, 1, 1, 0, i.RGBA, i.UNSIGNED_BYTE, J);
        return Y
    }
    const xe = {};
    ...
    function We(R, re) {
        return u[R] !== re ? (i.bindFramebuffer(R, re),
        u[R] = re,
        ...
        if (R) {
            ...
            if (Z.length !== J.length || Z[0] !== i.COLOR_ATTACHMENT0) {
                for (let Y = 0, fe = J.length; Y < fe; Y++)
                    Z[Y] = i.COLOR_ATTACHMENT0 + Y;
                Z.length = J.length,
                de = !0
            }
        } else
            Z[0] !== i.BACK && (Z[0] = i.BACK,
            de = !0);
        de && i.drawBuffers(Z)
    }
    function rt(R) {
        return _ !== R ? (i.useProgram(R),
        _ = R,
        !0) : !1
    }
    const at = {
    ...
    function A(R, re, Z, de, J, Y, fe, De, nt, Ke) {
        ...
        R !== Zl) {
            if (R !== m || Ke !== y) {
                if ((d !== Nn || S !== Nn) && (i.blendEquation(i.FUNC_ADD),
                d = Nn,
                S = Nn),
                Ke)
                    switch (R) {
        ...
        Y = Y || Z,
        fe = fe || de,
        (re !== d || J !== S) && (i.blendEquationSeparate(at[re], at[J]),
        d = re,
        S = J),
        (Z !== b || de !== T || Y !== I || fe !== w) && (i.blendFuncSeparate(Xe[Z], Xe[de], Xe[Y], Xe[fe]),
        b = Z,
        T = de,
        I = Y,
        w = fe),
        (De.equals(C) === !1 || nt !== N) && (i.blendColor(De.r, De.g, De.b, nt),
        C.copy(De),
        N = nt),
        m = R,
        y = !1
    ...
    function vt(R, re) {
        ...
        re && (Z = !Z),
        qe(Z),
        R.blending === oi && R.transparent === !1 ? A(Sn) : A(R.blending, R.blendEquation, R.blendSrc, R.blendDst, R.blendEquationAlpha, R.blendSrcAlpha, R.blendDstAlpha, R.blendColor, R.blendAlpha, R.premultipliedAlpha),
        ...
        o.setTest(de),
        de && (o.setMask(R.stencilWriteMask),
    ...
    function qe(R) {
        M !== R && (R ? i.frontFace(i.CW) : i.frontFace(i.CCW),
        M = R)
    }
    function tt(R) {
        R !== Yl ? (le(i.CULL_FACE),
        R !== P && (R === Ua ? i.cullFace(i.BACK) : R === Kl ? i.cullFace(i.FRONT) : i.cullFace(i.FRONT_AND_BACK))) : Me(i.CULL_FACE),
        P = R
    }
    function ge(R) {
        R !== q && (k && i.lineWidth(R),
    ...
    function Ve(R, re, Z) {
        R ? (le(i.POLYGON_OFFSET_FILL),
        (z !== re || W !== Z) && (i.polygonOffset(re, Z),
        z = re,
        W = Z)) : Me(i.POLYGON_OFFSET_FILL)
    }
    function Ee(R) {
        R ? le(i.SCISSOR_TEST) : Me(i.SCISSOR_TEST)
    }
    function Le(R) {
        R === void 0 && (R = i.TEXTURE0 + j - 1),
        oe !== R && (i.activeTexture(R),
        oe = R)
    }
    function ut(R, re, Z) {
        ...
        ue[Z] = de),
        (de.type !== R || de.texture !== re) && (oe !== Z && (i.activeTexture(Z),
        oe = Z),
        i.bindTexture(R, re || xe[R]),
        de.type = R,
        de.texture = re)
    }
    function E() {
    ...
    function ce(R) {
        Qe.equals(R) === !1 && (i.scissor(R.x, R.y, R.z, R.w),
        Qe.copy(R))
    }
    function Ae(R) {
        X.equals(R) === !1 && (i.viewport(R.x, R.y, R.z, R.w),
        X.copy(R))
    }
    function be(R, re) {
        let Z = c.get(re);
        ...
        c.set(re, Z));
        let de = Z.get(R);
        de === void 0 && (de = i.getUniformBlockIndex(re, R.name),
        Z.set(R, de))
    }
    function ne(R, re) {
        const de = c.get(re).get(R);
        l.get(re) !== de && (i.uniformBlockBinding(re, de, R.__bindingPointIndex),
        l.set(re, de))
    }
    function Pe() {
        i.disable(i.BLEND),
...
function Bm(i, e, t, n, s, r, a) {
    ...
    function x(E, g, F) {
        let G = 1;
        const K = ut(E);
        if ((K.width > F || K.height > F) && (G = F / Math.max(K.width, K.height)),
        G < 1)
            if (typeof HTMLImageElement < "u" && E instanceof HTMLImageElement || typeof HTMLCanvasElement < "u" && E instanceof HTMLCanvasElement || typeof ImageBitmap < "u" && E instanceof ImageBitmap || typeof VideoFrame < "u" && E instanceof VideoFrame) {
                ...
                console.warn("THREE.WebGLRenderer: Texture has been resized from (" + K.width + "x" + K.height + ") to (" + V + "x" + _e + ")."),
                se
            } else
    ...
    function T(E, g, F, G, K=!1) {
        ...
        return (V === i.R16F || V === i.R32F || V === i.RG16F || V === i.RG32F || V === i.RGBA16F || V === i.RGBA32F) && e.get("EXT_color_buffer_float"),
        V
    }
    function S(E, g) {
        let F;
        return E ? g === null || g === zn || g === Ui ? F = i.DEPTH24_STENCIL8 : g === Xt ? F = i.DEPTH32F_STENCIL8 : g === Li && (F = i.DEPTH24_STENCIL8,
        console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")) : g === null || g === zn || g === Ui ? F = i.DEPTH_COMPONENT24 : g === Xt ? F = i.DEPTH_COMPONENT32F : g === Li && (F = i.DEPTH_COMPONENT16),
        F
    }
    function I(E, g) {
        return m(E) === !0 || E.isFramebufferTexture && E.minFilter !== It && E.minFilter !== Zt ? Math.log2(Math.max(g.width, g.height)) + 1 : E.mipmaps !== void 0 && E.mipmaps.length > 0 ? E.mipmaps.length : E.isCompressedTexture && Array.isArray(E.image) ? g.mipmaps.length : 1
    }
    function w(E) {
        const g = E.target;
        ...
        E.isWebGLCubeRenderTarget)
            for (let G = 0; G < 6; G++) {
                if (Array.isArray(g.__webglFramebuffer[G]))
                    for (let K = 0; K < g.__webglFramebuffer[G].length; K++)
                        i.deleteFramebuffer(g.__webglFramebuffer[G][K]);
                else
            ...
            if (Array.isArray(g.__webglFramebuffer))
                for (let G = 0; G < g.__webglFramebuffer.length; G++)
                    i.deleteFramebuffer(g.__webglFramebuffer[G]);
            else
                i.deleteFramebuffer(g.__webglFramebuffer);
            if (g.__webglDepthbuffer && i.deleteRenderbuffer(g.__webglDepthbuffer),
    ...
    function z() {
        const E = P;
        return E >= s.maxTextures && console.warn("THREE.WebGLTextures: Trying to use " + E + " texture units while this GPU supports only " + s.maxTextures),
        P += 1,
        E
    }
    function W(E) {
        const g = [];
        return g.push(E.wrapS),
        g.push(E.wrapT),
        g.push(E.wrapR || 0),
        g.push(E.magFilter),
        g.push(E.minFilter),
    ...
    function j(E, g) {
        const F = n.get(E);
        if (E.isVideoTexture && Ee(E),
        E.isRenderTargetTexture === !1 && E.version > 0 && F.__version !== E.version) {
            const G = E.image;
            if (G === null)
    ...
    function Oe(E, g) {
        if (g.type === Xt && e.has("OES_texture_float_linear") === !1 && (g.magFilter === Zt || g.magFilter === zs || g.magFilter === Wi || g.magFilter === Bn || g.minFilter === Zt || g.minFilter === zs || g.minFilter === Wi || g.minFilter === Bn) && console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),
        ...
        g.compareFunction && (i.texParameteri(E, i.TEXTURE_COMPARE_MODE, i.COMPARE_REF_TO_TEXTURE),
        i.texParameteri(E, i.TEXTURE_COMPARE_FUNC, Se[g.compareFunction])),
        e.has("EXT_texture_filter_anisotropic") === !0) {
            if (g.magFilter === It || g.minFilter !== Wi && g.minFilter !== Bn || g.type === Xt && e.has("OES_texture_float_linear") === !1)
                return;
    ...
    function Qe(E, g) {
        ...
        if (V !== E.__cacheKey) {
            ...
            _e !== void 0 && (K[E.__cacheKey].usedTimes--,
            _e.usedTimes === 0 && y(g)),
            E.__cacheKey = V,
    ...
    function te(E, g, F, G) {
        ...
        if (V.length === 0)
            t.texSubImage2D(i.TEXTURE_2D, 0, 0, 0, g.width, g.height, F, G, g.data);
        else {
            ...
            for (let $ = 1; $ < V.length; $++) {
                ...
                Ae.start <= be + 1 && ne === Pe && X(Ae.start + Ae.count - 1, g.width, 4) === ne ? ce.count = Math.max(ce.count, Ae.start + Ae.count - ce.start) : (++_e,
                V[_e] = Ae)
            }
            V.length = _e + 1;
    ...
    function xe(E, g, F) {
        ...
        if (V.version !== _e.__version || K === !0) {
            ...
            if (g.isDepthTexture)
                ...
                re && (R ? t.texStorage2D(i.TEXTURE_2D, 1, be, $.width, $.height) : t.texImage2D(i.TEXTURE_2D, 0, be, $.width, $.height, 0, ce, Ae, null));
            else if (g.isDataTexture)
                if (Pe.length > 0) {
                    R && re && t.texStorage2D(i.TEXTURE_2D, de, be, Pe[0].width, Pe[0].height);
                    for (let J = 0, Y = Pe.length; J < Y; J++)
                        ne = Pe[J],
                        R ? Z && t.texSubImage2D(i.TEXTURE_2D, J, 0, 0, ne.width, ne.height, ce, Ae, ne.data) : t.texImage2D(i.TEXTURE_2D, J, be, ne.width, ne.height, 0, ce, Ae, ne.data);
                    g.generateMipmaps = !1
                } else
                    R ? (re && t.texStorage2D(i.TEXTURE_2D, de, be, $.width, $.height),
                    Z && te(g, $, ce, Ae)) : t.texImage2D(i.TEXTURE_2D, 0, be, $.width, $.height, 0, ce, Ae, $.data);
                                    ...
                                    if (Z)
                                        if (g.layerUpdates.size > 0) {
                                            ...
                                            for (const De of g.layerUpdates) {
                                                const nt = ne.data.subarray(De * fe / ne.data.BYTES_PER_ELEMENT, (De + 1) * fe / ne.data.BYTES_PER_ELEMENT);
                                                t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY, J, 0, 0, De, ne.width, ne.height, 1, ce, nt)
                                            }
                                            g.clearLayerUpdates()
                                        } else
                                            t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY, J, 0, 0, 0, ne.width, ne.height, $.depth, ce, ne.data)
                                } else
                                    t.compressedTexImage3D(i.TEXTURE_2D_ARRAY, J, be, ne.width, ne.height, $.depth, 0, ne.data, 0, 0);
                            else
                                console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");
                        else
                            R ? Z && t.texSubImage3D(i.TEXTURE_2D_ARRAY, J, 0, 0, 0, ne.width, ne.height, $.depth, ce, Ae, ne.data) : t.texImage3D(i.TEXTURE_2D_ARRAY, J, be, ne.width, ne.height, $.depth, 0, ce, Ae, ne.data)
                } else {
                    R && re && t.texStorage2D(i.TEXTURE_2D, de, be, Pe[0].width, Pe[0].height);
                    for (let J = 0, Y = Pe.length; J < Y; J++)
                        ne = Pe[J],
                        g.format !== Ot ? ce !== null ? R ? Z && t.compressedTexSubImage2D(i.TEXTURE_2D, J, 0, 0, ne.width, ne.height, ce, ne.data) : t.compressedTexImage2D(i.TEXTURE_2D, J, be, ne.width, ne.height, 0, ne.data) : console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()") : R ? Z && t.texSubImage2D(i.TEXTURE_2D, J, 0, 0, ne.width, ne.height, ce, Ae, ne.data) : t.texImage2D(i.TEXTURE_2D, J, be, ne.width, ne.height, 0, ce, Ae, ne.data)
                }
            else if (g.isDataArrayTexture)
                if (R) {
                    if (re && t.texStorage3D(i.TEXTURE_2D_ARRAY, de, be, $.width, $.height, $.depth),
                    Z)
                        if (g.layerUpdates.size > 0) {
                            const J = Ro($.width, $.height, g.format, g.type);
                            for (const Y of g.layerUpdates) {
                                const fe = $.data.subarray(Y * J / $.data.BYTES_PER_ELEMENT, (Y + 1) * J / $.data.BYTES_PER_ELEMENT);
                                t.texSubImage3D(i.TEXTURE_2D_ARRAY, 0, 0, 0, Y, $.width, $.height, 1, ce, Ae, fe)
                            }
                            g.clearLayerUpdates()
                        } else
                            t.texSubImage3D(i.TEXTURE_2D_ARRAY, 0, 0, 0, 0, $.width, $.height, $.depth, ce, Ae, $.data)
                } else
                    t.texImage3D(i.TEXTURE_2D_ARRAY, 0, be, $.width, $.height, $.depth, 0, ce, Ae, $.data);
            else if (g.isData3DTexture)
                R ? (re && t.texStorage3D(i.TEXTURE_3D, de, be, $.width, $.height, $.depth),
                Z && t.texSubImage3D(i.TEXTURE_3D, 0, 0, 0, 0, $.width, $.height, $.depth, ce, Ae, $.data)) : t.texImage3D(i.TEXTURE_3D, 0, be, $.width, $.height, $.depth, 0, ce, Ae, $.data);
            else if (g.isFramebufferTexture) {
                if (re)
                    if (R)
                        t.texStorage2D(i.TEXTURE_2D, de, be, $.width, $.height);
                    else {
                        let J = $.width
                          , Y = $.height;
                        for (let fe = 0; fe < de; fe++)
                            t.texImage2D(i.TEXTURE_2D, fe, be, J, Y, 0, ce, Ae, null),
                            J >>= 1,
                            Y >>= 1
                    }
            } else if (Pe.length > 0) {
                ...
                for (let J = 0, Y = Pe.length; J < Y; J++)
                    ne = Pe[J],
                    R ? Z && t.texSubImage2D(i.TEXTURE_2D, J, 0, 0, ce, Ae, ne) : t.texImage2D(i.TEXTURE_2D, J, be, ce, Ae, ne);
                g.generateMipmaps = !1
            } else if (R) {
                if (re) {
                    const J = ut($);
                ...
                t.texImage2D(i.TEXTURE_2D, 0, be, ce, Ae, $);
            m(g) && d(G),
            _e.__version = V.version,
            ...
            if (ve) {
                ...
                for (let Y = 0; Y < 6; Y++) {
                    ...
                    for (let fe = 0; fe < J.length; fe++) {
                        const De = J[fe];
                        g.format !== Ot ? be !== null ? R ? Z && t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X + Y, fe, 0, 0, De.width, De.height, be, De.data) : t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X + Y, fe, Pe, De.width, De.height, 0, De.data) : console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()") : R ? Z && t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X + Y, fe, 0, 0, De.width, De.height, be, ne, De.data) : t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X + Y, fe, Pe, De.width, De.height, 0, be, ne, De.data)
                    }
                }
            } else {
                if (J = g.mipmaps,
                ...
                for (let Y = 0; Y < 6; Y++)
                    if ($) {
                        R ? Z && t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X + Y, 0, 0, 0, ce[Y].width, ce[Y].height, be, ne, ce[Y].data) : t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X + Y, 0, Pe, ce[Y].width, ce[Y].height, 0, be, ne, ce[Y].data);
                        for (let fe = 0; fe < J.length; fe++) {
                            const nt = J[fe].image[Y].image;
                            R ? Z && t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X + Y, fe + 1, 0, 0, nt.width, nt.height, be, ne, nt.data) : t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X + Y, fe + 1, Pe, nt.width, nt.height, 0, be, ne, nt.data)
                        }
                    } else {
                        R ? Z && t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X + Y, 0, 0, 0, be, ne, ce[Y]) : t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X + Y, 0, Pe, be, ne, ce[Y]);
                        for (let fe = 0; fe < J.length; fe++) {
                            const De = J[fe];
                            R ? Z && t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X + Y, fe + 1, 0, 0, be, ne, De.image[Y]) : t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X + Y, fe + 1, Pe, be, ne, De.image[Y])
                        }
                    }
            }
    ...
    function Me(E, g, F, G, K, V) {
        ...
        !ve.__hasExternalTextures) {
            ...
            K === i.TEXTURE_3D || K === i.TEXTURE_2D_ARRAY ? t.texImage3D(K, V, me, ce, Ae, g.depth, 0, _e, se, null) : t.texImage2D(K, V, me, ce, Ae, 0, _e, se, null)
        }
        t.bindFramebuffer(i.FRAMEBUFFER, E),
        Ve(g) ? o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER, G, K, $.__webglTexture, 0, ge(g)) : (K === i.TEXTURE_2D || K >= i.TEXTURE_CUBE_MAP_POSITIVE_X && K <= i.TEXTURE_CUBE_MAP_NEGATIVE_Z) && i.framebufferTexture2D(i.FRAMEBUFFER, G, K, $.__webglTexture, V),
    ...
    function We(E, g, F) {
        ...
        g.depthBuffer) {
            const G = g.depthTexture
              ...
              , se = ge(g);
            Ve(g) ? o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER, se, V, g.width, g.height) : F ? i.renderbufferStorageMultisample(i.RENDERBUFFER, se, V, g.width, g.height) : i.renderbufferStorage(i.RENDERBUFFER, V, g.width, g.height),
            ...
            for (let K = 0; K < G.length; K++) {
                const V = G[K]
                  ...
                  , ve = ge(g);
                F && Ve(g) === !1 ? i.renderbufferStorageMultisample(i.RENDERBUFFER, ve, me, g.width, g.height) : Ve(g) ? o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER, ve, me, g.width, g.height) : i.renderbufferStorage(i.RENDERBUFFER, me, g.width, g.height)
            }
        }
    ...
    function we(E, g) {
        ...
        G.__renderTarget = g,
        (!G.__webglTexture || g.depthTexture.image.width !== g.width || g.depthTexture.image.height !== g.height) && (g.depthTexture.image.width = g.width,
        ...
        if (g.depthTexture.format === Ni)
            Ve(g) ? o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER, i.DEPTH_ATTACHMENT, i.TEXTURE_2D, K, 0, V) : i.framebufferTexture2D(i.FRAMEBUFFER, i.DEPTH_ATTACHMENT, i.TEXTURE_2D, K, 0);
        else if (g.depthTexture.format === Fi)
            Ve(g) ? o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER, i.DEPTH_STENCIL_ATTACHMENT, i.TEXTURE_2D, K, 0, V) : i.framebufferTexture2D(i.FRAMEBUFFER, i.DEPTH_STENCIL_ATTACHMENT, i.TEXTURE_2D, K, 0);
        else
    ...
    function rt(E) {
        ...
        if (g.__boundDepthTexture !== E.depthTexture) {
            ...
            G) {
                const K = () => {
                    ...
                    G.removeEventListener("dispose", K)
                }
                ;
        ...
        if (E.depthTexture && !g.__autoAllocateDepthBuffer) {
            ...
            for (let G = 0; G < 6; G++)
                if (t.bindFramebuffer(i.FRAMEBUFFER, g.__webglFramebuffer[G]),
                g.__webglDepthbuffer[G] === void 0)
                    g.__webglDepthbuffer[G] = i.createRenderbuffer(),
                    We(g.__webglDepthbuffer[G], E, !1);
                else {
            ...
            const G = E.texture.mipmaps;
            if (G && G.length > 0 ? t.bindFramebuffer(i.FRAMEBUFFER, g.__webglFramebuffer[0]) : t.bindFramebuffer(i.FRAMEBUFFER, g.__webglFramebuffer),
            g.__webglDepthbuffer === void 0)
                g.__webglDepthbuffer = i.createRenderbuffer(),
                We(g.__webglDepthbuffer, E, !1);
            else {
                const K = E.stencilBuffer ? i.DEPTH_STENCIL_ATTACHMENT : i.DEPTH_ATTACHMENT
    ...
    function Xe(E) {
        ...
        const K = E.textures
          ...
          , _e = K.length > 1;
        if (_e || (G.__webglTexture === void 0 && (G.__webglTexture = i.createTexture()),
        ...
        V) {
            ...
            for (let se = 0; se < 6; se++)
                if (g.mipmaps && g.mipmaps.length > 0) {
                    ...
                    for (let me = 0; me < g.mipmaps.length; me++)
                        F.__webglFramebuffer[se][me] = i.createFramebuffer()
                } else
            ...
            if (_e)
                for (let se = 0, me = K.length; se < me; se++) {
                    const ve = n.get(K[se]);
                    ve.__webglTexture === void 0 && (ve.__webglTexture = i.createTexture(),
                    a.memory.textures++)
                }
            if (E.samples > 0 && Ve(E) === !1) {
                ...
                for (let se = 0; se < K.length; se++) {
                    ...
                    i.framebufferRenderbuffer(i.FRAMEBUFFER, i.COLOR_ATTACHMENT0 + se, i.RENDERBUFFER, F.__webglColorRenderbuffer[se])
                }
                i.bindRenderbuffer(i.RENDERBUFFER, null),
                E.depthBuffer && (F.__webglDepthRenderbuffer = i.createRenderbuffer(),
                We(F.__webglDepthRenderbuffer, E, !0)),
                t.bindFramebuffer(i.FRAMEBUFFER, null)
            }
        }
        if (V) {
            t.bindTexture(i.TEXTURE_CUBE_MAP, G.__webglTexture),
            Oe(i.TEXTURE_CUBE_MAP, g);
            for (let se = 0; se < 6; se++)
                if (g.mipmaps && g.mipmaps.length > 0)
                    for (let me = 0; me < g.mipmaps.length; me++)
                    ...
                    Me(F.__webglFramebuffer[se], E, g, i.COLOR_ATTACHMENT0, i.TEXTURE_CUBE_MAP_POSITIVE_X + se, 0);
            m(g) && d(i.TEXTURE_CUBE_MAP),
            t.unbindTexture()
        } else if (_e) {
            for (let se = 0, me = K.length; se < me; se++) {
            ...
            let se = i.TEXTURE_2D;
            if ((E.isWebGL3DRenderTarget || E.isWebGLArrayRenderTarget) && (se = E.isWebGL3DRenderTarget ? i.TEXTURE_3D : i.TEXTURE_2D_ARRAY),
            t.bindTexture(se, G.__webglTexture),
            Oe(se, g),
            g.mipmaps && g.mipmaps.length > 0)
                for (let me = 0; me < g.mipmaps.length; me++)
                    Me(F.__webglFramebuffer[me], E, g, i.COLOR_ATTACHMENT0, se, me);
            else
                Me(F.__webglFramebuffer, E, g, i.COLOR_ATTACHMENT0, se, 0);
            m(g) && d(se),
            t.unbindTexture()
        }
        E.depthBuffer && rt(E)
    ...
    function tt(E) {
        if (E.samples > 0) {
            if (Ve(E) === !1) {
                ...
                me && me.length > 0 ? t.bindFramebuffer(i.DRAW_FRAMEBUFFER, _e.__webglFramebuffer[0]) : t.bindFramebuffer(i.DRAW_FRAMEBUFFER, _e.__webglFramebuffer);
                for (let ve = 0; ve < g.length; ve++) {
                    if (E.resolveDepthBuffer && (E.depthBuffer && (K |= i.DEPTH_BUFFER_BIT),
                    E.stencilBuffer && E.resolveStencilBuffer && (K |= i.STENCIL_BUFFER_BIT)),
                    se) {
                        i.framebufferRenderbuffer(i.READ_FRAMEBUFFER, i.COLOR_ATTACHMENT0, i.RENDERBUFFER, _e.__webglColorRenderbuffer[ve]);
                    ...
                    E.depthBuffer && E.resolveDepthBuffer === !1 && (vt.push(V),
                    qe.push(V),
                    i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER, qe)),
                ...
                se)
                    for (let ve = 0; ve < g.length; ve++) {
                        t.bindFramebuffer(i.FRAMEBUFFER, _e.__webglMultisampledFramebuffer),
                        i.framebufferRenderbuffer(i.FRAMEBUFFER, i.COLOR_ATTACHMENT0 + ve, i.RENDERBUFFER, _e.__webglColorRenderbuffer[ve]);
                        const $ = n.get(g[ve]).__webglTexture;
                        t.bindFramebuffer(i.FRAMEBUFFER, _e.__webglFramebuffer),
    ...
    function Le(E, g) {
        const F = E.colorSpace
          , G = E.format
          , K = E.type;
        return E.isCompressedTexture === !0 || E.isVideoTexture === !0 || F !== fi && F !== Mn && (Ge.getTransfer(F) === je ? (G !== Ot || K !== jt) && console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType.") : console.error("THREE.WebGLTextures: Unsupported texture color space:", F)),
        g
    }
    function ut(E) {
        return typeof HTMLImageElement < "u" && E instanceof HTMLImageElement ? (c.width = E.naturalWidth || E.width,
        c.height = E.naturalHeight || E.height) : typeof VideoFrame < "u" && E instanceof VideoFrame ? (c.width = E.displayWidth,
    ...
    function t(n, s=Mn) {
        ...
        if (n === Br || n === zr || n === Hr)
            ...
            r !== null) {
                ...
                return null;
        if (n === Vr || n === kr || n === Gr || n === Wr || n === Xr || n === qr || n === Yr || n === Kr || n === $r || n === Zr || n === jr || n === Jr || n === Qr || n === ea)
    ...
    constructor(e, t) {
        ...
        function z(X) {
            ...
            if (te === -1)
                return;
            const xe = T[te];
            xe !== void 0 && (xe.update(X.inputSource, X.frame, c || a),
            xe.dispatchEvent({
                type: X.type,
                data: X.inputSource
            }))
            ...
            s !== null) {
                ...
                typeof XRWebGLBinding < "u" && "createProjectionLayer"in XRWebGLBinding.prototype) {
                    ...
                    b = new Hn(f.textureWidth,f.textureHeight,{
                        format: Ot,
                        type: jt,
                        depthTexture: new wl(f.textureWidth,f.textureHeight,le,void 0,void 0,void 0,void 0,void 0,void 0,xe),
        ...
        const k = new U
          , ee = new U;
        function H(X, te, xe) {
            k.setFromMatrixPosition(te.matrixWorld),
            ee.setFromMatrixPosition(xe.matrixWorld);
        ...
        this.updateCamera = function(X) {
            ...
            let te = X.near
              , xe = X.far;
            x.texture !== null && (x.depthNear > 0 && (te = x.depthNear),
            x.depthFar > 0 && (xe = x.depthFar)),
            M.near = N.near = C.near = te,
            M.far = N.far = C.far = xe,
            (P !== M.near || q !== M.far) && (s.updateRenderState({
                depthNear: M.near,
                depthFar: M.far
            }),
            P = M.near,
            ...
            for (let We = 0; We < Me.length; We++)
                oe(Me[We], le);
            Me.length === 2 ? H(M, C, N) : M.projectionMatrix.copy(C.projectionMatrix),
            ue(X, M, le)
        }
        ;
        function ue(X, te, xe) {
            xe === null ? X.matrix.copy(te.matrixWorld) : (X.matrix.copy(xe.matrixWorld),
            X.matrix.invert(),
            ...
            X.projectionMatrix.copy(te.projectionMatrix),
            X.projectionMatrixInverse.copy(te.projectionMatrixInverse),
            X.isPerspectiveCamera && (X.fov = pi * 2 * Math.atan(1 / X.projectionMatrix.elements[5]),
            X.zoom = 1)
        }
        ...
        let Se = null;
        function Oe(X, te) {
            if (h = te.getViewerPose(c || a),
            _ = te,
            h !== null) {
                const xe = h.views;
                p !== null && (e.setRenderTargetFramebuffer(b, p.framebuffer),
                e.setRenderTarget(b));
                let le = !1;
                xe.length !== M.cameras.length && (M.cameras.length = 0,
                le = !0);
                for (let we = 0; we < xe.length; we++) {
                    ...
                    if (p !== null)
                        ...
                        at = A.viewport,
                        we === 0 && (e.setRenderTargetTextures(b, A.colorTexture, A.depthStencilTexture),
                        e.setRenderTarget(b))
                    }
                    let Xe = y[we];
                    Xe === void 0 && (Xe = new Et,
...
function Xm(i, e) {
    ...
    function s(m, d, b, T, S) {
        d.isMeshBasicMaterial || d.isMeshLambertMaterial ? r(m, d) : d.isMeshToonMaterial ? (r(m, d),
        u(m, d)) : d.isMeshPhongMaterial ? (r(m, d),
        h(m, d)) : d.isMeshStandardMaterial ? (r(m, d),
        f(m, d),
        d.isMeshPhysicalMaterial && p(m, d, S)) : d.isMeshMatcapMaterial ? (r(m, d),
        _(m, d)) : d.isMeshDepthMaterial ? r(m, d) : d.isMeshDistanceMaterial ? (r(m, d),
        x(m, d)) : d.isMeshNormalMaterial ? r(m, d) : d.isLineBasicMaterial ? (a(m, d),
        d.isLineDashedMaterial && o(m, d)) : d.isPointsMaterial ? l(m, d, b, T) : d.isSpriteMaterial ? c(m, d) : d.isShadowMaterial ? (m.color.value.copy(d.color),
    ...
    function r(m, d) {
        ...
        In.y *= -1,
        In.z *= -1,
        T.isCubeTexture && T.isRenderTargetTexture === !1 && (In.y *= -1,
        In.z *= -1),
        ...
        d.lightMap && (m.lightMap.value = d.lightMap,
...
function qm(i, e, t, n) {
            ...
            for (let y = 0, M = N.length; y < M; y++) {
                ...
                if (p(P, w, y, I) === !0) {
                    ...
                    for (let j = 0; j < z.length; j++) {
                        const k = z[j]
                          , ee = x(k);
                        typeof k == "number" || typeof k == "boolean" ? (P.__data[0] = k,
                        i.bufferSubData(i.UNIFORM_BUFFER, q + W, P.__data)) : k.isMatrix3 ? (P.__data[0] = k.elements[0],
                        ...
                        P.__data[11] = 0) : (k.toArray(P.__data, W),
                        W += ee.storage / Float32Array.BYTES_PER_ELEMENT)
                    }
    ...
    function p(b, T, S, I) {
        const w = b.value
          , C = T + "_" + S;
        if (I[C] === void 0)
            return typeof w == "number" || typeof w == "boolean" ? I[C] = w : I[C] = w.clone(),
            !0;
        {
            const N = I[C];
...
class Ym {
    constructor(e={}) {
        const {canvas: t=jc(), context: n=null, depth: s=!0, stencil: r=!1, alpha: a=!1, antialias: o=!1, premultipliedAlpha: l=!0, preserveDrawingBuffer: c=!1, powerPreference: h="default", failIfMajorPerformanceCaveat: u=!1, reverseDepthBuffer: f=!1} = e;
        ...
        try {
            ...
            if ("setAttribute"in t && t.setAttribute("data-engine", `three.js r${ha}`),
        ...
        this.clear = function(v=!0, D=!0, O=!0) {
            ...
            if (v) {
                ...
                if (L) {
                    ...
                    _[2] = ye,
                    _[3] = he,
                    A.clearBufferuiv(A.COLOR, 0, _)) : (x[0] = Re,
                    x[1] = Ce,
                    x[2] = ye,
                    x[3] = he,
        ...
        function fe(v) {
            const D = v.target;
            D.removeEventListener("dispose", fe),
            De(D)
        }
        function De(v) {
            nt(v),
        ...
        this.renderBufferDirect = function(v, D, O, B, L, Q) {
            ...
            let he = O.index
              , Re = 1;
            if (B.wireframe === !0) {
                if (he = F.getWireframeAttribute(O),
                he === void 0)
                    return;
                Re = 2
            }
            ...
            Q !== null && (He = Math.max(He, Q.start * Re),
            Ze = Math.min(Ze, (Q.start + Q.count) * Re)),
            he !== null ? (He = Math.max(He, 0),
            Ze = Math.min(Ze, he.count)) : ye != null && (He = Math.max(He, 0),
            Ze = Math.min(Ze, ye.count));
            const lt = Ze - He;
            if (lt < 0 || lt === 1 / 0)
                return;
            Pe.setup(L, B, pe, O, he);
            let it, et = Ae;
            if (he !== null && (it = g.get(he),
            et = be,
            et.setIndex(it)),
            L.isMesh)
                B.wireframe === !0 ? (ge.setLineWidth(B.wireframeLinewidth * Xe()),
                et.setMode(A.LINES)) : et.setMode(A.TRIANGLES);
            else if (L.isLine) {
                let Te = B.linewidth;
                Te === void 0 && (Te = 1),
                ...
                L.isPoints ? et.setMode(A.POINTS) : L.isSprite && et.setMode(A.TRIANGLES);
            if (L.isBatchedMesh)
                if (L._multiDrawInstances !== null)
                    li("THREE.WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),
                    et.renderMultiDrawInstances(L._multiDrawStarts, L._multiDrawCounts, L._multiDrawCount, L._multiDrawInstances);
                    ...
                    for (let wt = 0; wt < ke; wt++)
                        kn.setValue(A, "_gl_DrawID", wt),
                        et.render(Te[wt] / At, ot[wt])
                }
            else if (L.isInstancedMesh)
                et.renderInstances(He, lt, L.count);
        ...
        ;
        function Ke(v, D, O) {
            v.transparent === !0 && v.side === ln && v.forceSinglePass === !1 ? (v.side = Tt,
            v.needsUpdate = !0,
            Gi(v, D, O),
            v.side = En,
            v.needsUpdate = !0,
        ...
        this.setAnimationLoop = function(v) {
            zt = v,
            Z.setAnimationLoop(v),
            v === null ? bn.stop() : bn.start()
        }
        ,
        ...
        this.render = function(v, D) {
            ...
            Z.enabled === !0 && Z.isPresenting === !0 && (Z.cameraAutoUpdate === !0 && Z.updateCamera(D),
            D = Z.getCamera()),
            ...
            D.isArrayCamera) {
                ...
                L.length > 0 && Ca(B, L, v, D),
                at && $.render(v),
                Ra(m, v, D);
            N !== null && C === 0 && (Le.updateMultisampleRenderTarget(N),
            Le.updateRenderTargetMipmap(N)),
            ...
            te === !0 && me.setGlobalState(S.clippingPlanes, d.state.camera)) : d = null,
            b.pop(),
        ...
        function Os(v, D, O, B) {
            ...
            if (v.layers.test(D.layers)) {
                if (v.isGroup)
                    ...
                    we.copy(v.boundingSphere.center)) : (ae.boundingSphere === null && ae.computeBoundingSphere(),
        ...
        function Ca(v, D, O, B) {
            if ((O.isScene === !0 ? O.overrideMaterial : null) !== null)
                return;
            d.state.transmissionRenderTarget[B.id] === void 0 && (d.state.transmissionRenderTarget[B.id] = new Hn(1,1,{
                generateMipmaps: !0,
            ...
            S.getClearColor(W),
            j = S.getClearAlpha(),
            j < 1 && S.setClearColor(16777215, .5),
            S.clear(),
            at && $.render(O);
            ...
            qe.has("WEBGL_multisampled_render_to_texture") === !1) {
                ...
                He === !0 && (Le.updateMultisampleRenderTarget(Q),
                Le.updateRenderTargetMipmap(Q))
            }
            S.setRenderTarget(pe, he, Re),
            S.setClearColor(W, j),
            ye !== void 0 && (B.viewport = ye),
            S.toneMapping = Ce
        }
        function ki(v, D, O) {
            ...
            for (let L = 0, Q = v.length; L < Q; L++) {
                ...
                pe.layers.test(O.layers) && Pa(pe, D, O, he, Ce, Re)
            }
        }
        function Pa(v, D, O, B, L, Q) {
            ...
            L.transparent === !0 && L.side === ln && L.forceSinglePass === !1 ? (L.side = Tt,
            L.needsUpdate = !0,
            S.renderBufferDirect(O, D, B, L, v, Q),
            L.side = En,
            L.needsUpdate = !0,
            S.renderBufferDirect(O, D, B, L, v, Q),
            L.side = ln) : S.renderBufferDirect(O, D, B, L, v, Q),
        ...
        function Gi(v, D, O) {
            ...
            Re === void 0 && (v.addEventListener("dispose", fe),
            Re = new Map,
            B.programs = Re);
            let Ce = Re.get(he);
            if (Ce !== void 0) {
            ...
            const ye = B.uniforms;
            return (!v.isShaderMaterial && !v.isRawShaderMaterial || v.clipping === !0) && (ye.clippingPlanes = me.uniform),
            Ia(v, pe),
            B.needsLights = Vl(v),
            B.lightsStateVersion = ae,
            B.needsLights && (ye.ambientLightColor.value = L.state.ambient,
        ...
        function zl(v, D, O, B, L) {
            ...
            let ke = !1;
            B.version === Te.__version ? (Te.needsLights && Te.lightsStateVersion !== ot.state.version || Te.outputColorSpace !== pe || L.isBatchedMesh && Te.batching === !1 || !L.isBatchedMesh && Te.batching === !0 || L.isBatchedMesh && Te.batchingColor === !0 && L.colorTexture === null || L.isBatchedMesh && Te.batchingColor === !1 && L.colorTexture !== null || L.isInstancedMesh && Te.instancing === !1 || !L.isInstancedMesh && Te.instancing === !0 || L.isSkinnedMesh && Te.skinning === !1 || !L.isSkinnedMesh && Te.skinning === !0 || L.isInstancedMesh && Te.instancingColor === !0 && L.instanceColor === null || L.isInstancedMesh && Te.instancingColor === !1 && L.instanceColor !== null || L.isInstancedMesh && Te.instancingMorph === !0 && L.morphTexture === null || L.isInstancedMesh && Te.instancingMorph === !1 && L.morphTexture !== null || Te.envMap !== he || B.fog === !0 && Te.fog !== Q || Te.numClippingPlanes !== void 0 && (Te.numClippingPlanes !== me.numPlanes || Te.numIntersection !== me.numIntersection) || Te.vertexAlphas !== Re || Te.vertexTangents !== Ce || Te.morphTargets !== ye || Te.morphNormals !== He || Te.morphColors !== Ze || Te.toneMapping !== lt || Te.morphTargetsCount !== et) && (ke = !0) : (ke = !0,
            Te.__version = B.version);
            ...
            const st = At.getUniforms()
              , Lt = Te.uniforms;
            if (ge.useProgram(At.program) && (kn = !0,
            wt = !0,
            Si = !0),
            B.id !== y && (y = B.id,
            wt = !0),
            kn || M !== v) {
                ge.buffers.depth.getReversed() ? (le.copy(v.projectionMatrix),
                Qc(le),
                eh(le),
                st.setValue(A, "projectionMatrix", le)) : st.setValue(A, "projectionMatrix", v.projectionMatrix),
                ...
                (B.isMeshPhongMaterial || B.isMeshToonMaterial || B.isMeshLambertMaterial || B.isMeshBasicMaterial || B.isMeshStandardMaterial || B.isShaderMaterial) && st.setValue(A, "isOrthographic", v.isOrthographicCamera === !0),
                M !== v && (M = v,
                wt = !0,
                Si = !0)
            }
            if (L.isSkinnedMesh) {
                st.setOptional(A, L, "bindMatrix"),
                st.setOptional(A, L, "bindMatrixInverse");
                const xt = L.skeleton;
                xt && (xt.boneTexture === null && xt.computeBoneTexture(),
                st.setValue(A, "boneTexture", xt.boneTexture, Le))
            }
            L.isBatchedMesh && (st.setOptional(A, L, "batchingTexture"),
            ...
            if ((Ut.position !== void 0 || Ut.normal !== void 0 || Ut.color !== void 0) && ce.update(L, O, At),
            (wt || Te.receiveShadow !== L.receiveShadow) && (Te.receiveShadow = L.receiveShadow,
            st.setValue(A, "receiveShadow", L.receiveShadow)),
            B.isMeshGouraudMaterial && B.envMap !== null && (Lt.envMap.value = he,
            Lt.flipEnvMap.value = he.isCubeTexture && he.isRenderTargetTexture === !1 ? -1 : 1),
            B.isMeshStandardMaterial && B.envMap === null && D.environment !== null && (Lt.envMapIntensity.value = D.environmentIntensity),
            wt && (st.setValue(A, "toneMappingExposure", S.toneMappingExposure),
            ...
            B.isShaderMaterial && B.uniformsNeedUpdate === !0 && (Ts.upload(A, Da(Te), Lt, Le),
        ...
        this.setRenderTarget = function(v, D=0, O=0) {
            ...
            if (v) {
                ...
                if (he.__useDefaultFramebuffer !== void 0)
                    ge.bindFramebuffer(A.FRAMEBUFFER, null),
                    B = !1;
                else if (he.__webglFramebuffer === void 0)
                    Le.setupRenderTarget(v);
                ...
                v.isWebGLCubeRenderTarget ? (Array.isArray(Ce[D]) ? L = Ce[D][O] : L = Ce[D],
                Q = !0) : v.samples > 0 && Le.useMultisampledRTT(v) === !1 ? L = Ee.get(v).__webglMultisampledFramebuffer : Array.isArray(Ce) ? L = Ce[O] : L = Ce,
                P.copy(v.viewport),
                q.copy(v.scissor),
                z = v.scissorTest
            } else
                P.copy(Se).multiplyScalar(H).floor(),
                q.copy(Oe).multiplyScalar(H).floor(),
                z = Qe;
            if (O !== 0 && (L = kl),
            ...
            Q) {
                ...
                A.framebufferTexture2D(A.FRAMEBUFFER, A.COLOR_ATTACHMENT0, A.TEXTURE_CUBE_MAP_POSITIVE_X + D, he.__webglTexture, O)
            } else if (ae) {
                const he = Ee.get(v.texture)
                  , Re = D;
        ...
        this.readRenderTargetPixels = function(v, D, O, B, L, Q, ae, pe=0) {
            ...
            if (v.isWebGLCubeRenderTarget && ae !== void 0 && (he = he[ae]),
            he) {
                ...
                try {
                    ...
                    D >= 0 && D <= v.width - B && O >= 0 && O <= v.height - L && (v.textures.length > 1 && A.readBuffer(A.COLOR_ATTACHMENT0 + pe),
        ...
        this.copyFramebufferToTexture = function(v, D=null, O=0) {
            const B = Math.pow(2, -O)
              ...
              , pe = D !== null ? D.y : 0;
            Le.setTexture2D(v, 0),
            A.copyTexSubImage2D(A.TEXTURE_2D, O, 0, 0, ae, pe, L, Q),
            ge.unbindTexture()
        }
        ;
        ...
        this.copyTextureToTexture = function(v, D, O=null, B=null, L=0, Q=null) {
            Q === null && (L !== 0 ? (li("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),
            Q = L,
            L = 0) : Q = 0);
            ...
            let ot;
            D.isData3DTexture ? (Le.setTexture3D(D, 0),
            ot = A.TEXTURE_3D) : D.isDataArrayTexture || D.isCompressedArrayTexture ? (Le.setTexture2DArray(D, 0),
            ot = A.TEXTURE_2D_ARRAY) : (Le.setTexture2D(D, 0),
            ot = A.TEXTURE_2D),
            ...
            if (v.isDepthTexture) {
                ...
                for (let An = 0; An < he; An++)
                    st && (A.framebufferTextureLayer(A.READ_FRAMEBUFFER, A.COLOR_ATTACHMENT0, Ee.get(v).__webglTexture, L, ye + An),
                ...
                ge.bindFramebuffer(A.READ_FRAMEBUFFER, null),
                ge.bindFramebuffer(A.DRAW_FRAMEBUFFER, null)
            } else if (L !== 0 || v.isRenderTargetTexture || Ee.has(v)) {
                const Ut = Ee.get(v)
                  , xt = Ee.get(D);
                ge.bindFramebuffer(A.READ_FRAMEBUFFER, Gl),
                ge.bindFramebuffer(A.DRAW_FRAMEBUFFER, Wl);
                for (let yt = 0; yt < he; yt++)
                    st ? A.framebufferTextureLayer(A.READ_FRAMEBUFFER, A.COLOR_ATTACHMENT0, Ut.__webglTexture, L, ye + yt) : A.framebufferTexture2D(A.READ_FRAMEBUFFER, A.COLOR_ATTACHMENT0, A.TEXTURE_2D, Ut.__webglTexture, L),
                    Lt ? A.framebufferTextureLayer(A.DRAW_FRAMEBUFFER, A.COLOR_ATTACHMENT0, xt.__webglTexture, Q, lt + yt) : A.framebufferTexture2D(A.DRAW_FRAMEBUFFER, A.COLOR_ATTACHMENT0, A.TEXTURE_2D, xt.__webglTexture, Q),
                    L !== 0 ? A.blitFramebuffer(Re, Ce, ae, pe, He, Ze, ae, pe, A.COLOR_BUFFER_BIT, A.NEAREST) : Lt ? A.copyTexSubImage3D(ot, Q, He, Ze, lt + yt, Re, Ce, ae, pe) : A.copyTexSubImage2D(ot, Q, He, Ze, Re, Ce, ae, pe);
                ge.bindFramebuffer(A.READ_FRAMEBUFFER, null),
                ge.bindFramebuffer(A.DRAW_FRAMEBUFFER, null)
            } else
                Lt ? v.isDataTexture || v.isData3DTexture ? A.texSubImage3D(ot, Q, He, Ze, lt, ae, pe, he, et, Te, it.data) : D.isCompressedArrayTexture ? A.compressedTexSubImage3D(ot, Q, He, Ze, lt, ae, pe, he, et, it.data) : A.texSubImage3D(ot, Q, He, Ze, lt, ae, pe, he, et, Te, it) : v.isDataTexture ? A.texSubImage2D(A.TEXTURE_2D, Q, He, Ze, ae, pe, et, Te, it.data) : v.isCompressedTexture ? A.compressedTexSubImage2D(A.TEXTURE_2D, Q, He, Ze, it.width, it.height, et, it.data) : A.texSubImage2D(A.TEXTURE_2D, Q, He, Ze, ae, pe, et, Te, it);
        ...
        this.copyTextureToTexture3D = function(v, D, O=null, B=null, L=0) {
            return li('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),
        ...
        this.initTexture = function(v) {
            v.isCubeTexture ? Le.setTextureCube(v, 0) : v.isData3DTexture ? Le.setTexture3D(v, 0) : v.isDataArrayTexture || v.isCompressedArrayTexture ? Le.setTexture2DArray(v, 0) : Le.setTexture2D(v, 0),
            ge.unbindTexture()
        }
        ,
...
class Ol {
    ...
    createGradient() {
        ...
        return e.addColorStop(0, t),
        e.addColorStop(1, n),
        e
    }
    initializeCanvas() {
        this.context && (this.context.imageSmoothingEnabled = !1,
    ...
    update(e, t, n=0) {
        ...
        this.context.fillStyle = this.fg,
        this.context.fillText(`${e.toFixed(n)} ${this.name} (${s.toFixed(n)}-${parseFloat(r.toFixed(n))})`, this.TEXT_X, this.TEXT_Y)
    }
    updateGraph(e, t) {
        if (!this.context || !this.gradient)
            return;
        ...
        l > 0 && (this.context.globalAlpha = .9,
...
class Km extends Ol {
    ...
    update(e, t, n=0) {
        this.context && (this.vsyncValue = e,
...
const Bl = class ri {
    constructor({trackGPU: e=!1, trackCPT: t=!1, trackHz: n=!1, logsPerSecond: s=4, graphsPerSecond: r=30, samplesLog: a=40, samplesGraph: o=10, precision: l=2, minimal: c=!1, horizontal: h=!0, mode: u=0}={}) {
        this.gl = null,
        this.ext = null,
        ...
        this.trackHz === !0 && (this.vsyncPanel = new Km("","#f0f","#202"),
    ...
    setupEventListeners() {
        this.minimal ? (this.dom.addEventListener("click", this.handleClick),
        this.showPanel(this.mode)) : window.addEventListener("resize", this.handleResize)
    }
    async init(e) {
        if (!e) {
    ...
    handleThreeRenderer(e) {
        return e.isWebGLRenderer && !this.threeRendererPatched ? (this.patchThreeRenderer(e),
        this.gl = e.getContext(),
        this.trackGPU && this.initializeGPUTracking(),
        !0) : !1
    }
    async handleWebGPURenderer(e) {
        return e.isWebGPURenderer ? ((this.trackGPU || this.trackCPT) && (e.backend.trackTimestamp = !0,
    ...
    initializeWebGL(e) {
        if (e instanceof WebGL2RenderingContext)
            ...
            if (this.gl = e.getContext("webgl2"),
            !this.gl)
                return console.error("Stats: Unable to obtain WebGL2 context."),
                !1
        } else
            return console.error("Stats: Invalid input type. Expected WebGL2RenderingContext, HTMLCanvasElement, or OffscreenCanvas."),
            !1;
        return !0
    }
    initializeGPUTracking() {
        this.gl && (this.ext = this.gl.getExtension("EXT_disjoint_timer_query_webgl2"),
        this.ext && (this.gpuPanel = this.addPanel(new ri.Panel("GPU","#ff0","#220"))))
    }
    begin() {
        this.beginProfiling("cpu-started"),
        !(!this.gl || !this.ext) && (this.activeQuery && this.gl.endQuery(this.ext.TIME_ELAPSED_EXT),
    ...
    resizePanel(e) {
        ...
        this.minimal ? e.canvas.style.display = "none" : (e.canvas.style.display = "block",
        this.horizontal ? (e.canvas.style.top = "0px",
        e.canvas.style.left = e.id * e.WIDTH / e.PR + "px") : (e.canvas.style.left = "0px",
        e.canvas.style.top = e.id * e.HEIGHT / e.PR + "px"))
    }
    addPanel(e) {
        return e.canvas && (this.dom.appendChild(e.canvas),
        e.id = this._panelId,
        this.resizePanel(e),
        this._panelId++),
        e
    ...
    processGpuQueries() {
        !this.gl || !this.ext || (this.totalGpuDuration = 0,
    ...
    endInternal() {
        ...
        if (this.updatePanelComponents(this.fpsPanel, this.averageFps, 0, s, r),
        ...
        this.trackCPT && this.gpuPanelCompute && this.updatePanelComponents(this.gpuPanelCompute, this.averageGpuCompute, this.precision, s, r),
    ...
    updatePanelComponents(e, t, n, s, r) {
        if (!e || t.logs.length === 0)
            return;
        e.name in this.lastMin || (this.lastMin[e.name] = 1 / 0,
        this.lastMax[e.name] = 0,
        this.lastValue[e.name] = 0);
        const a = t.logs[t.logs.length - 1];
        this.lastMax[e.name] = Math.max(...t.logs),
        this.lastMin[e.name] = Math.min(this.lastMin[e.name], a),
        this.lastValue[e.name] = this.lastValue[e.name] * .7 + a * .3;
        const o = Math.max(Math.max(...t.logs), ...t.graph.slice(-this.samplesGraph));
        this.updateCounter++,
        s && e.update(this.lastValue[e.name], this.lastMax[e.name], n),
        r && e.updateGraph(a, o)
    }
    beginProfiling(e) {
    ...
    updatePanel(e, t, n=2) {
        ...
        this.lastValue[e.name] = this.lastValue[e.name] * .7 + r * .3;
        const o = Math.max(a, ...t.graph.slice(-this.samplesGraph));
        this.updateCounter++,
        this.updateCounter % (this.logsPerSecond * 2) === 0 && (this.lastMax[e.name] = a,
        this.lastMin[e.name] = r),
        e.update && (s >= this.prevCpuTime + 1e3 / this.logsPerSecond && e.update(this.lastValue[e.name], r, this.lastMax[e.name], o, n),
        s >= this.prevGraphTime + 1e3 / this.graphsPerSecond && (e.updateGraph(r, o),
        this.prevGraphTime = s))
    }
    updateAverages() {
        this.addToAverage(this.totalCpuDuration, this.averageCpu),
        this.addToAverage(this.totalGpuDuration, this.averageGpu),
        this.info && this.totalGpuDurationCompute !== void 0 && this.addToAverage(this.totalGpuDurationCompute, this.averageGpuCompute)
    }
    addToAverage(e, t) {
        t.logs.push(e),
...
class Zm {
    ...
    setInstance() {
        ...
        this.instance = new Et(65,this.sizes.width / this.canvas.parentElement.offsetHeight,.1,1e3),
    ...
    debug() {
        if (!this.app.debug.active)
            return;
        this.app.debug.gui.addFolder("Camera").close().add(this.instance, "fov", 1, 180, .01).name("FOV").onChange( () => this.resize())
    }
    resize() {
...
class jm {
    ...
    setInstance() {
        this.instance = new Ym({
            canvas: this.canvas,
            alpha: !0,
            antialias: !0,
            powerPreference: "high-performance"
        }),
        this.instance.setSize(this.sizes.width, window.innerWidth > 480 ? this.sizes.height : this.canvas.parentElement.offsetHeight),
...
let eg = class {
    ...
    debug() {
        ...
        e.add(this.material.uniforms.uProgress, "value", 0, 1, .01).name("Progress"),
        e.add(this.material.uniforms.uMultiplier1, "value", 0, 10, .01).name("Noise Multiplier 1"),
        e.add(this.material.uniforms.uMultiplier2, "value", 0, 10, .01).name("Noise Multiplier 2"),
        e.add(this.material.uniforms.uMultiplier3, "value", 0, 10, .01).name("Noise Multiplier 3")
    }
    onMouseMove(e, t) {
        this.material.uniforms.uMouseX = new Pt(t.x * .15)
    }
    setMesh() {
    ...
    update() {
        this.material.uniforms.uTime.value = this.app.time.elapsed * .001
    }
    destroy() {
...
class tg {
    ...
    init() {
        ...
        this.glowSize = this.canvas.width * .25,
    ...
    onMouseMove(e, t) {
        this.loaded && (this.mouse.x = (t.x + 1) / 2,
...
class ng extends Xl {
    constructor(e, t, n) {
        ...
        !this.app.options.onceLoaded && this.main.getAttribute("data-transition-page") == "home" && (this.loaderGradient = new eg(this.app,this),
        this.app.loaderGradientAdded = !0),
        this.loadWorld(this.main),
        this.app.debug.active && (this.stats = new $m({
            trackGPU: !1,
            minimal: !0
        }),
        ...
        ql.add( () => this.update(), {
            fps: window.innerWidth > 768 ? "100%" : 40
        }),
    ...
    update() {
        this.isPageHidden || (this.camera.update(),
    ...
    destroy() {
        ...
        this.loaderGradient && (this.loaderGradient.destroy(),
        this.loaderGradient = null)
    }
    async loadWorld(e) {
        switch (e.getAttribute("data-transition-page")) {
        case "home":
            await La( () => import("./World.BECZFbeu.js"), __vite__mapDeps([0, 1, 2, 3, 4, 5, 6, 7, 8])).then(n => this.world = new n.default(this,this.app,this.scene,e));
            break;
        case "about":
            await La( () => import("./World.ACdR9IeJ.js"), __vite__mapDeps([9, 2, 3, 5, 1, 6, 4, 7, 8])).then(n => this.world = new n.default(this,this.app,this.scene,e));
            break;
        default:
            setTimeout( () => {
...
const Ag = Object.freeze(Object.defineProperty({
    __proto__: null,
    default: ng
}, Symbol.toStringTag, {
    value: "Module"
}));
export {Et as $, Tg as A, Yt as B, Ne as C, Sg as D, Uh as E, _g as F, os as G, Vn as H, dg as I, Fh as J, ln as K, bl as L, gl as M, Wi as N, ct as O, Mg as P, _i as Q, Ir as R, dn as S, rg as T, Pt as U, Fe as V, Je as W, ug as X, Lh as Y, fg as Z, pg as _, Rl as a, lg as a0, Dl as a1, Tl as a2, gg as a3, wh as a4, bs as a5, aa as a6, yl as a7, mt as a8, Ds as a9, Ps as aa, Ns as ab, Ge as ac, En as ad, Us as ae, Tn as af, fn as ag, Ag as ah, Dt as b, Bt as c, Al as d, U as e, og as f, ag as g, Vi as h, eg as i, yg as j, mg as k, fi as l, Ft as m, xg as n, ze as o, mo as p, vg as q, Eg as r, hg as s, Bn as t, zs as u, Ec as v, Zt as w, It as x, Lr as y, On as z};
