...
class y {
    constructor(e, r, i) {
        ...
        this.phrases = ["agentic", "modular", "scalable"],
        this.destroyed = !1,
        this.entered = !1,
        this.currenIndex = 0,
        this.modelFaded = !1,
    ...
    sideBarAnimation() {
        this.destroyed || (this.sidebarTl = s.timeline({
            defaults: {
                ease: "linear"
            }
        }),
        this.sidebarTl.fromTo(this.sidebar, {
            opacity: 1
        }, {
    ...
    createSlashes() {
        this.slashes.forEach(e => {
            ...
            for (let h = 0; h < a; h++) {
                ...
                l.className = "_12 f-mono sm_7 leading-1.2",
                l.textContent = "/",
                e.appendChild(l)
            }
        }
    ...
    createModelFadeTimeline() {
        if (!this.app.gl || !this.app.gl.world)
            return;
        const e = this.app.gl.world;
        if (!e.material || !e.material.material)
            return;
        const r = e.material.material.uniforms;
        this.modelFadeTl = s.timeline({
            paused: !0,
            defaults: {
                ease: "power2.inOut"
            }
        }),
        this.modelFadeTl.to(r.uLoading, {
            value: 0,
            duration: 1.2
        }),
    ...
    init() {
        ...
        this.enterTl.fromTo(this.split.chars, {
            yPercent: 110
        }, {
            yPercent: 0,
            duration: .8,
        ...
        this.logoTl = s.timeline({
            defaults: {
                ease: "power2"
            },
            paused: !0
        }),
        this.logoTl.fromTo(this.logoSvgs, {
            yPercent: 100
        }, {
            yPercent: 0,
            stagger: .1
    ...
    createNewPhrase() {
        ...
        this.newSplit = new n(this.selectedLine,{
            type: "words, chars",
            charsClass: "footer_char"
        }),
    ...
    destroy() {
        ...
        s.to(document.querySelector(".sidebar"), {
            ...
            delay: .5,
            duration: .3,
            onComplete: () => s.set(document.querySelector(".sidebar"), {
                clearProps: "opacity"
            })
        }))
    }
