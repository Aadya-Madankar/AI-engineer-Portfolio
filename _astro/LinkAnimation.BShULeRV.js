...
class o {
    ...
    init() {
        this.split = new e(this.text[0],{
            type: "chars, lines",
            charsClass: "link-char"
        }),
        this.splitSecond = new e(this.text[1],{
            type: "chars, lines",
            charsClass: "link-char"
        }),
        ...
        this.tl.to(this.split.chars, {
            yPercent: -110
        }, 0).fromTo(this.splitSecond.chars, {
            yPercent: 110
        }, {
            yPercent: 0
        }, "<0.1"),
    ...
    resize() {
        this.destroyed || (this.instance.removeEventListener("mouseenter", () => this.tl.play()),
