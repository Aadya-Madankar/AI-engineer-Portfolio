...
class u {
    ...
    init() {
        ...
        this.tl.fromTo(this.split.lines[0], {
            autoAlpha: 0
        }, {
            autoAlpha: 1,
            duration: .7
        }, 0).fromTo(this.split.lines[0], {
            xPercent: -10
        }, {
            xPercent: 0,
            duration: .8,
        ...
        this.split.lines[1] && this.tl.fromTo(this.split.lines[1], {
            autoAlpha: 0
        }, {
            autoAlpha: 1,
            duration: .15
        }, "<0.4").fromTo(this.split.lines[1], {
            xPercent: 10
        }, {
            xPercent: 0,
            duration: .5,
        ...
        this.split.lines[2] && this.tl.fromTo(this.split.lines[2], {
            autoAlpha: 0
        }, {
            autoAlpha: 1,
            duration: .15
        }, "<0.2").fromTo(this.split.lines[2], {
            xPercent: -10
        }, {
            xPercent: 0,
            duration: .5,
        ...
        this.split.lines[3] && this.tl.fromTo(this.split.lines[3], {
            autoAlpha: 0
        }, {
            autoAlpha: 1,
            duration: .15
        }, "<0.2").fromTo(this.split.lines[3], {
            xPercent: 10
        }, {
            xPercent: 0,
            duration: .5,
        ...
        this.split.lines[4] && this.tl.fromTo(this.split.lines[4], {
            autoAlpha: 0
        }, {
            autoAlpha: 1,
            duration: .15
        }, "<0.2").fromTo(this.split.lines[4], {
            xPercent: -10
        }, {
            xPercent: 0,
            duration: .5,
        ...
        this.notAnimateY) {
            if (window.innerWidth < 1023)
                return;
            this.heroTitleEnterTl = i.timeline({
                paused: !0,
                defaults: {
                    ease: "linear"
                }
            }),
            this.heroTitleEnterTl.fromTo(this.textParent, {
                y: window.innerHeight * .5 + this.textParent.offsetHeight
            }, {
                y: 0
            }),
            this.heroTitleLeaveTl = i.timeline({
                paused: !0,
                defaults: {
                    ease: "linear"
                }
            }),
            this.heroTitleLeaveTl.fromTo(this.textParent, {
                y: 0
            }, {
                y: (window.innerHeight * .5 + this.textParent.offsetHeight) * -1,
                immediateRender: !1
            }),
            ...
            const e = this.calculateTop() - this.calculateTop() * .2
    ...
    resize() {
        this.destroyed || (this.heroTitleEnterScroll?.kill(),
